    ...
    <div class="col-12 lg:col-12">
      <div class="formgrid grid">
        ...
        <div class="field col-12 sm:col-6 lg:col-6">
          ...
          <InputText type="text" class="w-full" v-model="form.MiddleName" />
        </div>

        <div class="field col-12 sm:col-6 lg:col-6">
          <label class="block text-600 text-sm font-bold mb-2"> นามสกุล </label>
          <InputText
            type="text"
            class="w-full"
        ...
        <div class="field col-12 sm:col-6">
          ...
          <Dropdown
            ...
            :class="{ 'p-invalid': !form.MainOccupationID && valid }"
          >
            <template v-slot:loader="{ options }">
              <div class="flex align-items-center p-2" style="height: 38px">
                <Skeleton :width="options.even ? '60%' : '50%'" height="1rem" />
        ...
        <div class="field col-12 sm:col-6">
          ...
          <Dropdown
            ...
            :class="{ 'p-invalid': !form.SecondOccupationID && valid }"
          >
            <template v-slot:loader="{ options }">
              <div class="flex align-items-center p-2" style="height: 38px">
                <Skeleton :width="options.even ? '60%' : '50%'" height="1rem" />
        ...
        <div class="field col-12">
          ...
          <Dropdown
            ...
            :class="{ 'p-invalid': !form.FarmerRegisterStatus && valid }"
          >
            <template v-slot:loader="{ options }">
              <div class="flex align-items-center p-2" style="height: 38px">
                <Skeleton :width="options.even ? '60%' : '50%'" height="1rem" />
              ...
              <div class="formgrid grid">
                <div class="field col-12 sm:col-6">
                  ...
                  <InputText
                    ...
                    :class="{ 'p-invalid': !form.HouseBuildingNumber && valid }"
                  />
                </div>
                <div class="field col-12 sm:col-6">
                  <label class="block text-600 text-sm font-bold mb-2">
                  ...
                  <InputText
                    ...
                    :class="{ 'p-invalid': !form.HouseMoo && valid }"
                  />
                </div>
                <div class="field col-12 sm:col-6">
                  <label class="block text-600 text-sm font-bold mb-2">
                  ...
                  <InputText
                    ...
                    :class="{ 'p-invalid': !form.HouseVillageName && valid }"
                  />
                </div>
                <div class="field col-12 sm:col-6">
                  <label class="block text-600 text-sm font-bold mb-2">
                  ...
                  <InputText
                    ...
                    :class="{ 'p-invalid': !form.HouseFloor && valid }"
                  />
                </div>
                <div class="field col-12 sm:col-6">
                  <label class="block text-600 text-sm font-bold mb-2">
                  ...
                  <InputText
                    ...
                    :class="{ 'p-invalid': !form.HouseStreet && valid }"
                  />
                </div>
                ...
                <div class="field col-12 sm:col-6">
                  ...
                  <InputText
                    ...
                    :class="{ 'p-invalid': !form.HouseSubLane && valid }"
                  />
                </div>
                <div class="field col-12 sm:col-6">
                  <label class="block text-600 text-sm font-bold mb-2">
                  ...
                  <InputText
                    ...
                    :class="{ 'p-invalid': !form.HouseLane && valid }"
                  />
                </div>
                <div class="field col-12 sm:col-6">
                  <label class="block text-600 text-sm font-bold mb-2">
                  ...
                  <Dropdown
                    ...
                    :class="{ 'p-invalid': !form.HouseProvinceID && valid }"
                  >
                    <template v-slot:loader="{ options }">
                      <div
                ...
                <div class="field col-12 sm:col-6">
                  ...
                  <Dropdown
                    ...
                    :class="{ 'p-invalid': !form.HouseAmphurID && valid }"
                  >
                    <template v-slot:loader="{ options }">
                      <div
                        class="flex align-items-center p-2"
                ...
                <div class="field col-12 sm:col-6">
                  ...
                  <Dropdown
                    ...
                    :class="{ 'p-invalid': !form.HouseTumbolID && valid }"
                  >
                    <template v-slot:loader="{ options }">
                      <div
                        class="flex align-items-center p-2"
                ...
                <div class="field col-12 sm:col-6">
                  ...
                  <InputText
                    ...
                    :class="{
                      'p-invalid': !form.HouseAddressIdentification && valid,
                    }"
                  />
                </div>
                <div class="field col-12 sm:col-6">
                  ...
                  <InputText
                    ...
                    :class="{ 'p-invalid': !form.HouseLatitude && valid }"
                  />
                </div>
                <div class="field col-12 sm:col-6">
                  <label class="block text-600 text-sm font-bold mb-2">
                  ...
                  <InputText
                    ...
                    :class="{ 'p-invalid': !form.HouseLongitude && valid }"
                  />
                </div>
              </div>
            </div>
              ...
              <div class="formgrid grid">
                <div class="field col-12 sm:col-6">
                  ...
                  <InputText
                    ...
                    :class="{
                      'p-invalid': !form.ResidenceBuildingNumber && valid,
                    }"
                  />
                </div>
                <div class="field col-12 sm:col-6">
                  ...
                  <InputText
                    ...
                    :class="{ 'p-invalid': !form.ResidenceMoo && valid }"
                  />
                </div>
                <div class="field col-12 sm:col-6">
                  <label class="block text-600 text-sm font-bold mb-2">
                  ...
                  <InputText
                    ...
                    :class="{
                      'p-invalid': !form.ResidenceVillageName && valid,
                    }"
                  />
                </div>
                <div class="field col-12 sm:col-6">
                  ...
                  <InputText
                    ...
                    :class="{ 'p-invalid': !form.ResidenceFloor && valid }"
                  />
                </div>
                <div class="field col-12 sm:col-6">
                  <label class="block text-600 text-sm font-bold mb-2">
                  ...
                  <InputText
                    ...
                    :class="{ 'p-invalid': !form.ResidenceStreet && valid }"
                  />
                </div>
                ...
                <div class="field col-12 sm:col-6">
                  ...
                  <InputText
                    ...
                    :class="{ 'p-invalid': !form.ResidenceSubLane && valid }"
                  />
                </div>
                <div class="field col-12 sm:col-6">
                  <label class="block text-600 text-sm font-bold mb-2">
                  ...
                  <InputText
                    ...
                    :class="{ 'p-invalid': !form.ResidenceLane && valid }"
                  />
                </div>
                <div class="field col-12 sm:col-6">
                  <label class="block text-600 text-sm font-bold mb-2">
                  ...
                  <Dropdown
                    ...
                    :class="{ 'p-invalid': !form.ResidenceProvinceID && valid }"
                  >
                    <template v-slot:loader="{ options }">
                      <div
                        class="flex align-items-center p-2"
                ...
                <div class="field col-12 sm:col-6">
                  ...
                  <Dropdown
                    ...
                    :class="{ 'p-invalid': !form.ResidenceAmphurID && valid }"
                  >
                    <template v-slot:loader="{ options }">
                      <div
                        class="flex align-items-center p-2"
                ...
                <div class="field col-12 sm:col-6">
                  ...
                  <Dropdown
                    ...
                    :class="{ 'p-invalid': !form.ResidenceTumbolID && valid }"
                  >
                    <template v-slot:loader="{ options }">
                      <div
                        class="flex align-items-center p-2"
                ...
                <div class="field col-12 sm:col-6">
                  ...
                  <InputText
                    ...
                    :class="{
                      'p-invalid':
                        !form.ResidenceAddressIdentification && valid,
                    }"
                  />
                </div>
                <!-- <div class="field col-12 sm:col-6">
    ...
    fillname($event) {
      ...
      if (val) {
        ...
        this.form = {
          ...
          ResidenceAddressIdentification: val.ResidenceAddressIdentification,
            ...
            axios
              ...
              .then((res) => {
                ...
                this.form = {
                  ...
                  FarmerNumber: this.data.farmerGET.FarmerNumber,
                  FarmID: this.data.farmerGET.FarmID,
                  IdentificationNumber:
                    this.data.farmerGET.IdentificationNumber,
                  ...
                  TelephoneNumber: this.data.farmerGET.TelephoneNumber,
                  MobilePhoneNumber: this.data.farmerGET.MobilePhoneNumber,
                  EducationID: this.data.farmerGET.EducationID,
                  Email: this.data.farmerGET.Email,
                  IDLine: this.data.farmerGET.IDLine,
                  MainOccupationID: this.data.farmerGET.MainOccupationID,
                  SecondOccupationID: this.data.farmerGET.SecondOccupationID,
                  HouseBuildingNumber: this.data.farmerGET.HouseBuildingNumber,
                  HouseMoo: this.data.farmerGET.HouseMoo,
                  HouseVillageName: this.data.farmerGET.HouseVillageName,
                  HouseFloor: this.data.farmerGET.HouseFloor,
                  HouseStreet: this.data.farmerGET.HouseStreet,
                  HouseSubLane: this.data.farmerGET.HouseSubLane,
                  HouseLane: this.data.farmerGET.HouseLane,
                  HouseTumbolID: this.data.farmerGET.HouseTumbolID,
                  HouseAmphurID: this.data.farmerGET.HouseAmphurID,
                  HouseProvinceID: this.data.farmerGET.HouseProvinceID,
                  HouseZipCode: this.data.farmerGET.HouseZipCode,
                  HouseAddressIdentification:
                    this.data.farmerGET.HouseAddressIdentification,
                  HouseLatitude: this.data.farmerGET.HouseLatitude,
                  HouseLongitude: this.data.farmerGET.HouseLongitude,
                  ResidenceBuildingNumber:
                    this.data.farmerGET.ResidenceBuildingNumber,
                  ResidenceMoo: this.data.farmerGET.ResidenceMoo,
                  ResidenceVillageName:
                    this.data.farmerGET.ResidenceVillageName,
                  ResidenceFloor: this.data.farmerGET.ResidenceFloor,
                  ResidenceStreet: this.data.farmerGET.ResidenceStreet,
                  ResidenceSubLane: this.data.farmerGET.ResidenceSubLane,
                  ResidenceLane: this.data.farmerGET.ResidenceLane,
                  ResidenceTumbolID: this.data.farmerGET.ResidenceTumbolID,
                  ResidenceAmphurID: this.data.farmerGET.ResidenceAmphurID,
                  ResidenceProvinceID: this.data.farmerGET.ResidenceProvinceID,
                  ResidenceZipCode: this.data.farmerGET.ResidenceZipCode,
                  ResidenceAddressIdentification:
                    this.data.farmerGET.ResidenceAddressIdentification,
                  FarmerRegisterStatus:
                    this.data.farmerGET.FarmerRegisterStatus,
                  FarmerRegisterDate: this.data.farmerGET.FarmerRegisterDate,
                };
              })
              .finally(() => {
