    ...
    <form class="grid mt-2">
      <div class="col-12 lg:col-12">
        <div class="grid">
          ...
          <div class="col-12 lg:col-6">
            <label class="block text-600 text-sm font-bold mb-2">
              วันที่แท้ง<span class="text-red-500"> *</span></label
            >
            <!-- <Calendar
              :maxDate="new Date()"
              :manualInput="false"
            ...
            <Datepicker
              v-model="data[index].AbortDate"
              :class="{ 'p-invalid': !data[index].AbortDate && valid }"
              id="dateRange"
              locale="th"
              :format="format"
              utc
          ...
          <div class="col-12 lg:col-6">
            <label class="block text-600 text-sm font-bold mb-2">
              ลักษณะการแท้ง<span class="text-red-500"> *</span></label
            >
            <Dropdown
              emptyMessage="ไม่มีข้อมูล"
              emptyFilterMessage="ไม่พบข้อมูล"
              ...
              :class="{
                'p-invalid': !data[index].AbortResultID && valid,
              }"
            />
          </div>
