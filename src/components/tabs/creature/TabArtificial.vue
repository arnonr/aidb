        ...
        <form class="grid mt-2" v-if="animal_id == 3">
          ...
          <Calendar
            ...
            />
                    ...
                    <div class="col-12 lg:col-6">
                        <label class="block text-600 text-sm font-bold mb-2">
                            ผสมครั้งที่<span class="text-red-500">
                                *</span
                            ></label
                        >
                        <InputNumber
            ...
            >
                    ...
                    <div class="col-12 lg:col-6">
                        <label class="block text-600 text-sm font-bold mb-2">
                            วิธีการผสม<span class="text-red-500">
                                *</span
                            ></label
                        >
                        <Dropdown
                    ...
                    <div class="col-12 lg:col-6" v-if="checkMethod == 3">
                        <label class="block text-600 text-sm font-bold mb-2">
                            การเป็นสัด<span class="text-red-500">
                                *</span
                            ></label
                        >
                        <Dropdown
                            ...
                            :class="{
                                'p-invalid':
                                    !data[index].GoatEstralActivityID && valid,
                            }"
                        />
                    </div>
                    ...
                    >
                        ...
                        <InputText
                            ...
                            :class="{
                                'p-invalid':
                                    !data[index].InseminationTime && valid,
                            }"
                            readonly
                        />
                    </div>
            ...
            /> -->
                    ...
                    >
                        ...
                        <Dropdown
                            ...
                            :class="{
                                'p-invalid':
                                    !data[index].MucilageQuantity1 && valid,
                            }"
                        />
                    </div>
                    <div
                    ...
                    >
                        ...
                        <Dropdown
                            ...
                            :class="{
                                'p-invalid':
                                    !data[index].MucilageQuality1 && valid,
                            }"
                        />
                    </div>
                    <div
                    ...
                    >
                        ...
                        <Datepicker
                            ...
                            :class="{
                                'p-invalid': !data[index].AIDate2 && valid,
                            }"
                            id="dateRange"
                            locale="th"
                            :format="format"
            ...
            /> -->
                    ...
                    >
                        ...
                        <Datepicker
                            ...
                            :class="{
                                'p-invalid': !data[index].AIDate3 && valid,
                            }"
                            id="dateRange"
                            locale="th"
                            :format="format"
            ...
            /> -->
                    ...
                    >
                        ...
                        <Datepicker
                            ...
                            :class="{
                                'p-invalid': !data[index].AIDate4 && valid,
                            }"
                            id="dateRange"
                            locale="th"
                            :format="format"
            ...
            /> -->
                    ...
                    >
                        ...
                        <Datepicker
                            ...
                            :class="{
                                'p-invalid': !data[index].AIDate5 && valid,
                            }"
                            id="dateRange"
                            locale="th"
                            :format="format"
    ...
    >
        <div class="mt-2 grid align-items-center">
            <h1 class="mb-2 lg:mb-0 mr-2 text-md p-2">
                วันที่ผสมเทียมครั้งล่าสุดน้อยกว่า 30 วัน
                คุณต้องการผสมเทียมหรือไม่?
            </h1>
        </div>
        <div class="mt-2 grid align-items-center">
...
export default {
    ...
    methods: {
        ...
        async checkabort() {
            ...
            await axios
                .get(`/give-birth?AnimalID=${this.AnimalID}`)
                .then((res) => {
                    birth = res.data;
                });
            ...
            if (abort.rows.length > 0 || birth.rows.length > 0) {
                ...
                if ($d1 <= 30 || $d2 <= 30) {
                    await Swal.fire({
                        title: "จำนวนวันคลอด/แท้ง ถึงวันที่ผสมเทียม น้อยกว่า 30 วัน ต้องการบันทึกผสมเทียมหรือไม่",
                        showDenyButton: true,
                        confirmButtonText: "ต้องการ",
                        denyButtonText: "ยกเลิก",
                        allowOutsideClick: false,
                        ...
                        if (result.isConfirmed) {
                            ...
                            if (
                                ...
                                if (
                                    abort.rows[0].AbortDate >
                                    birth.rows[0].GiveBirthDate
                                ) {
                                    this.date_last_event =
                                        abort.rows[0].AbortDate;
                                } else {
                                    this.date_last_event =
                                        birth.rows[0].GiveBirthDate;
                        ...
                        axios
                            ...
                            .then((response) => {
                                if (
                                    ...
                                    this.selection[i] = this.selection[i].map(
                                        (item) => {
                                            return {
        ...
        async open() {
            ...
            if (this.display_abort == true) {
                ...
                if (this.display_birth == true) {
                    ...
                    let test = dayjs(this.olddate).isBefore(
                        dayjs(this.olddate1)
                    );
                    if (test == true) {
