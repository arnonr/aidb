            ...
            <template #body="slotProps">
                <div class="flex justify-content-center align-items-center">
                    <div class="mx-1">
                        <span
                            v-if="
                                slotProps.data.BabyStatus == 2 ||
                                slotProps.data.BabyStatus == 3
                            "
                        >
                        ...
                        <span v-else>
                            {{ slotProps.data.CountChildAnimal }}/{{
                                slotProps.data.Amount
                            }}
                        </span>
                    </div>
    ...
    >
        <form class="grid mt-2">
            ...
            /> -->
                    ...
                    <div class="col-12 lg:col-6">
                        <label class="block text-600 text-sm font-bold mb-2">
                            ภาวะการคลอด<span class="text-red-500">
                                *</span
                            ></label
                        >
                        <Dropdown
                            ...
                            :class="{
                                'p-invalid':
                                    !data[index].GiveBirthState && valid,
                            }"
                        />
                    </div>
                    <div class="col-12 lg:col-6">
                        <label class="block text-600 text-sm font-bold mb-2">
                            วิธีการช่วยคลอด<span class="text-red-500">
                                *</span
                            ></label
                        >
                        <Dropdown
                            ...
                            :class="{
                                'p-invalid':
                                    !data[index].GiveBirthHelpID && valid,
                            }"
                        />
                    </div>
                    <div class="col-12 lg:col-6">
        ...
        <div class="mt-2 grid align-items-center">
            <div class="col-6">
                ...
                <Tag class="text-md p-2 mb-2 lg:mb-0 mr-2 text-md p-2"
                    >ลูกที่คลอดทั้งหมด
                    {{ `${this.data[this.index].Amount}` }} ตัว</Tag
                >
    ...
    methods: {
        ...
        edit(id) {
            ...
            if (this.data[this.index].ChildGender) {
                this.data[this.index].Male = (
                    this.data[this.index].ChildGender.match(
                        new RegExp("M", "g")
                    ) || []
                ).length;
        ...
        async openConfirmBirth() {
            ...
            if (this.animal_id == 1) {
                if (this.data[this.index].GiveBirthDate) {
                    ...
                    this.txtCheck =
                        "จำนวนวันตั้งแต่ผสมครั้งล่าสุด ถึงวันคลอดอยู่ระหว่าง" +
                        res +
                        "วัน";
                    ...
                    if (this.data.length != 0) {
                        ...
                        let dateDiff2 = dayjs(
                            this.data[this.index].GiveBirthDate
                        ).diff(this.animalInfo.AnimalBirthDate, "day");
                ...
                if (this.data[this.index].GiveBirthDate) {
                    ...
                    if (error == 2) {
                        this.txtCheck =
                            "ไม่สามารถบันทึกคลอดก่อนวันเกิดแม่พันธุ์ได้";
                        this.displayViewConfirmBirth = true;
                        this.btnSubmit = false;
                    } else if (error == 1) {
                        this.txtCheck =
        ...
        openRegister(id, day, index, type) {
            ...
            if (this.data[this.index].TransferEmbryo) {
                fatherid =
                    this.data[this.index].TransferEmbryo.Embryo.MaleBreederID;
            ...
            let item = {
                ...
                OrganizationZoneID:
                    this.animalInfo.OrganizationZone.OrganizationZoneID,
                AnimalBirthDate: day,
                FatherID: fatherid,
                BornType: borntype,
            };
