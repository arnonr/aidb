        ...
        <form class="grid mt-2">
            <div class="col-12 lg:col-12">
                <div class="grid">
                    ...
                    <div class="col-12 lg:col-6">
                        <label class="block text-600 text-sm font-bold mb-2">
                            วันที่คัดจำหน่าย<span class="text-red-500">
                                *</span
                            ></label
                        >
                        <!-- <Calendar
            ...
            /> -->
                        ...
                        <Datepicker
                            ...
                            :class="{
                                'p-invalid':
                                    !data[index].DistributionDate && valid,
                            }"
                            id="dateRange"
                            locale="th"
                            :format="format"
                    ...
                    <div class="col-12 lg:col-6">
                        <label class="block text-600 text-sm font-bold mb-2">
                            ประเภทการคัดจำหน่าย<span class="text-red-500">
                                *</span
                            ></label
                        >
                        <Dropdown
                            ...
                            :class="{
                                'p-invalid':
                                    !data[index].DistributionType && valid,
                            }"
                        />
                    </div>
                    <div class="col-12 lg:col-6">
        ...
        async add() {
            ...
            if (
                ...
                if (this.data[this.index].DistributionType == "SALE") {
                    let DesFarmID =
                        this.data[this.index].DestinationFarmID.FarmID;
                ...
                if (farmCheck.project_id == 19) {
                    if (
                        ...
                        this.$toast.add({
                            severity: "error",
                            summary: "ล้มเหลว",
                            detail: "เป็นฟาร์มในโครงการผลิตน้ำเชื้อพ่อพันธุ์ สิทธิ์ของคุณไม่สามารถเคลื่อนย้่ายได้",
                            life: 5000,
                        });
                        return;
                    }
        ...
        async open() {
            ...
            await axios
                ...
                .then((response) => {
                    ...
                    this.show.farm_id = response.data.rows[0].AnimalFarm.FarmID;
            ...
            if (this.selection.DestinationFarmID != null) {
                if (this.data[this.index].DestinationFarmID != null) {
                    ...
                    let Farm1 = this.selection.DestinationFarmID.find((x) => {
                        return (
                            this.data[this.index].DestinationFarmID == x.FarmID
                        );
                    });
