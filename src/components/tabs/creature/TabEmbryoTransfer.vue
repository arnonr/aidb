        ...
        <form class="grid mt-2" v-if="animal_id == 3">
            <div class="col-12 lg:col-12">
                <div class="grid">
                    ...
                    <div class="col-12 lg:col-6">
                        <label class="block text-600 text-sm font-bold mb-2">
                            หมายเลขตัวอ่อน<span class="text-red-500">
                                *</span
                            ></label
                        >
                        <Dropdown
                    ...
                    <div class="col-12 lg:col-6">
                        <label class="block text-600 text-sm font-bold mb-2">
                            วิธีการย้ายฝาก<span class="text-red-500">
                                *</span
                            ></label
                        >
                        <Dropdown
                            ...
                            :class="{
                                'p-invalid':
                                    !data[index].TransferMethodID && valid,
                            }"
                        />
                    </div>
                    <div class="col-12 lg:col-6">
                        <label class="block text-600 text-sm font-bold mb-2">
                            วันที่ย้ายฝาก<span class="text-red-500">
                                *</span
                            ></label
                        >
                        <Calendar
                    ...
                    <div class="col-12 lg:col-6">
                        <label class="block text-600 text-sm font-bold mb-2">
                            วันที่เป็นสัด<span class="text-red-500">
                                *</span
                            ></label
                        >
                        <Calendar
                            ...
                            :class="{
                                'p-invalid':
                                    !data[index].StandingHeatDate && valid,
                            }"
                        />
                    </div>
