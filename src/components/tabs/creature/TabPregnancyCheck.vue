    ...
    >
        ...
        <form class="grid mt-2">
                ...
                <div class="grid">
                    ...
                    <div class="col-12 lg:col-6">
                        ...
                        <InputNumber
                            ...
                            :class="{
                                'p-invalid':
                                    !data[index].PregnancyCheckupTimeNo &&
                                    valid,
                            }"
                        />
                    </div>
                    <div class="col-12 lg:col-6">
                        <label class="block text-600 text-sm font-bold mb-2">
                            วันที่ตรวจท้อง<span class="text-red-500">
                                *</span
                            ></label
                        >
                        <!-- <Calendar
            ...
            /> -->
                    ...
                    <div class="col-12 lg:col-6">
                        <label class="block text-600 text-sm font-bold mb-2">
                            วิธีการตรวจการตั้งท้อง<span class="text-red-500">
                                *</span
                            ></label
                        >
                        <Dropdown
                            ...
                            :class="{
                                'p-invalid':
                                    !data[index].PregnancyCheckMethodID &&
                                    valid,
                            }"
                        />
                    </div>
                    <div class="col-12 lg:col-6">
                        <label class="block text-600 text-sm font-bold mb-2">
                            ผลการตรวจการตั้งท้อง<span class="text-red-500">
                                *</span
                            ></label
                        >
                        <Dropdown
                            ...
                            :class="{
                                'p-invalid':
                                    !data[index].PregnancyCheckStatusID &&
                                    valid,
                            }"
                        />
                    </div>
