  ...
  <div class="grid flex align-items-center mt-3 mb-5">
    ...
    <div class="col-12 md:col-6 md:text-right">
      <Button
        ...
        @click="open_add()"
        v-if="AnimalSecretStatus.includes(7) && permit[0].IsAdd"
      />
    </div>
  </div>
  <DataTable
        ...
        <div class="formgrid grid">
          ...
          <div class="field col-12 sm:col-6">
            <label class="block text-600 text-sm font-bold mb-2">
              วันที่เป็นสัด (ในรอบปัจจุบัน)<span class="text-red-500"> *</span>
            </label>
            <Datepicker
          ...
          <div class="field col-12 sm:col-6">
            ...
            <InputText class="w-full" v-model="form.FarmerRemark" type="text" />
          </div>
            ...
            <div class="flex">
              <div class="mr-3">
                <div class="field-radiobutton">
                  ...
                  />
                  <label for="intumesceDiagnoseVulva">บวม</label>
                </div>
              </div>
              <div>
                <div class="field-radiobutton">
                  <RadioButton
                    ...
                    v-model="form.DiagnoseVulva"
                  />
                  <label for="normalDiagnoseVulva">ไม่บวม</label>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="flex">
              <div class="mr-3">
                <div class="field-radiobutton">
                  ...
                  />
                  <label for="intumesceDiagnoseVagina">บวม</label>
                </div>
              </div>
              <div>
                <div class="field-radiobutton">
                  <RadioButton
                    ...
                    v-model="form.DiagnoseVagina"
                  />
                  <label for="normalDiagnoseVagina">ไม่บวม</label>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="flex">
              <div class="mr-3">
                <div class="field-radiobutton">
                  ...
                  />
                  <label for="yesDiagnoseVaginaMucilage">มีเมือก</label>
                </div>
              </div>
              <div>
                <div class="field-radiobutton">
                  <RadioButton
                    ...
                    v-model="form.DiagnoseVaginaMucilage"
                  />
                  <label for="noDiagnoseVagina">ไม่มีเมือก</label>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="field col-12 sm:col-6">
            ...
            <InputText class="w-full" type="number" v-model="form.AdnexaSize" />
          </div>
          <div class="field col-12 sm:col-6">
            <label class="block text-600 text-sm font-bold mb-3">
              ...
              <div>
                <div class="field-radiobutton">
                  <RadioButton
                    ...
                    v-model="form.AdnexaType"
                  />
                  <label for="unEqualCervical">ไม่เท่ากัน</label>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="field col-12 sm:col-6">
            <label class="block text-600 text-sm font-bold mb-2">
              หมายเหตุ <span class="text-yellow-500">(ถ้ามี)</span>
            </label>
            <InputText
              class="w-full"
              type="text"
          ...
          <div class="field col-12">
            ...
            <div v-if="form.CureByHormone == 1">
              ...
              /> -->
              <template v-for="item in cureByHormoneSettings" :key="item.id">
                <div class="formgrid grid">
                  <div class="field col-6">
                    ...
                    <Dropdown
                      ...
                      optionValue="CureHormoneID"
                      :options="selection.CureHormone"
                      v-model="form.CureHormoneName[item.id - 1]"
                    />
                  </div>
                  <div class="field col-6">
                    <label class="block text-600 text-sm font-bold mb-2">
                    ...
                    <InputNumber
                      id="minmaxfraction"
                      v-model="form.CureHormoneValue[item.id - 1]"
                      mode="decimal"
                      :minFractionDigits="2"
                      :maxFractionDigits="5"
                      class="w-full"
          ...
          <div class="field col-12">
            <div class="field-checkbox">
              ...
              />
              <label for="cureByAntibiotic">รักษาโดยยาปฏิชีวนะ</label>
            </div>
            <div v-if="form.CureByAntibiotic == 1">
              ...
              <template v-for="item in cureAntibioticSettings" :key="item.id">
                <div class="formgrid grid">
                  <div class="field col-6">
                    <label class="block text-600 text-sm font-bold mb-2">
                      เลือกยาปฏิชีวนะ
                    ...
                    <Dropdown
                      ...
                      v-model="form.CureAntibioticName[item.id - 1]"
                    />
                  </div>
                  <div class="field col-6">
                    <label class="block text-600 text-sm font-bold mb-2">
                    ...
                    <InputNumber
                      id="minmaxfraction"
                      v-model="form.CureAntibioticValue[item.id - 1]"
                      mode="decimal"
                      :minFractionDigits="2"
                      :maxFractionDigits="5"
                      class="w-full"
          ...
          <div class="field col-12">
            ...
            <div v-if="form.CureByVitamin == 1">
              ...
              <template v-for="item in cureVitaminSettings" :key="item.id">
                <div class="formgrid grid">
                  <div class="field col-6">
                    <label class="block text-600 text-sm font-bold mb-2">
                      เลือกยาวิตามิน
                    ...
                    <Dropdown
                      ...
                      v-model="form.CureVitaminName[item.id - 1]"
                    />
                    <!-- <Dropdown
                      class="w-full"
                      v-model="item.name"
                  ...
                  <div class="field col-6">
                    ...
                    <InputNumber
                      id="minmaxfraction"
                      v-model="form.CureVitaminValue[item.id - 1]"
                      mode="decimal"
                      :minFractionDigits="2"
                      :maxFractionDigits="5"
                      class="w-full"
          ...
          <div class="field col-12">
            <div class="field-checkbox">
              ...
              />
              <label for="cureByCleanUterus">รักษาโดยชะล้างมดลูก</label>
            </div>
            <div v-if="form.CureByCleanUterus == 1">
              <label class="block text-600 text-sm font-bold mb-2">
                หมายเหตุชะล้างมดลูก <span class="text-yellow-500">(ถ้ามี)</span>
              </label>
              <InputText
                class="w-full"
                type="text"
          ...
          <div class="field col-12">
            <div class="field-checkbox">
              <Checkbox value="1" id="CureByOther" v-model="form.CureByOther" />
          ...
          <div class="field col-12 sm:col-6">
            ...
            <Datepicker
              v-model="form.ReproduceDate"
              :class="{ 'p-invalid': !form.ReproduceDate && valid }"
              id="dateRange"
              locale="th"
              :format="format"
              utc
          ...
          <div class="field col-12 sm:col-6">
            <label class="block text-600 text-sm font-bold mb-2">
              เจ้าหน้าที่ผู้วินิจฉัย<span class="text-red-500"> *</span>
            </label>
            <Dropdown
              :virtualScrollerOptions="{ itemSize: 38 }"
              emptyMessage="ไม่มีข้อมูล"
    ...
    <form class="grid mt-2">
      <div class="col-12 lg:col-12">
        <div class="formgrid grid">
          ...
          <div class="field col-12">
            <div class="field-checkbox">
              <Checkbox :binary="true" v-model="form.CureByHormone" />
              <label for="cureByHormone">รักษาโดยฮอร์โมน</label>
            </div>
            <div v-if="form.CureByHormone">
              ...
              <MultiSelect
                ...
                v-model="form.CureHormoneID"
              /> -->
              <template v-for="item in cureByHormoneEdit" :key="item">
                <div class="formgrid grid">
                  <div class="field col-6">
                    <label class="block text-600 text-sm font-bold mb-2">
                      เลือกฮอร์โมน
          ...
          <div class="field col-12">
            <div class="field-checkbox">
              <Checkbox :binary="true" v-model="form.CureByAntibiotic" />
              <label for="cureByAntibiotic">รักษาโดยยาปฏิชีวนะ</label>
            </div>
            <div v-if="form.CureByAntibiotic">
              ...
              <MultiSelect class="w-full" placeholder="เลือกยาปฏิชีวนะ" display="chip" optionLabel="CureAntibioticName"
                optionValue="CureAntibioticID" :options="selection.CureAntibiotic" v-model="form.CureAntibioticID" /> -->
              <template v-for="item in cureByAntibioticEdit" :key="item">
                <div class="formgrid grid">
                  <div class="field col-6">
                    <label class="block text-600 text-sm font-bold mb-2">
                      เลือกยาปฏิชีวนะ
                    ...
                    <Dropdown
                      ...
                      optionValue="CureAntibioticID"
                      :options="selection.CureAntibiotic"
                      v-model="form.CureAntibioticName[item - 1]"
                    />
                  </div>
                  <div class="field col-6">
                    <label class="block text-600 text-sm font-bold mb-2">
                    ...
                    <InputNumber
                      id="minmaxfraction"
                      v-model="form.CureAntibioticValue[item - 1]"
                      mode="decimal"
                      :minFractionDigits="2"
                      :maxFractionDigits="5"
                      class="w-full"
          ...
          <div class="field col-12">
            <div class="field-checkbox">
              <Checkbox :binary="true" v-model="form.CureByVitamin" />
              <label for="cureByVitamin">รักษาโดยวิตามิน</label>
            </div>
            <div v-if="form.CureByVitamin">
              ...
              <MultiSelect class="w-full" placeholder="เลือกวิตามิน" display="chip" optionLabel="CureVitaminName"
                optionValue="CureVitaminID" :options="selection.CureVitamin" v-model="form.CureVitaminID" /> -->
              <template v-for="item in cureByVitaminEdit" :key="item">
                <div class="formgrid grid">
                  <div class="field col-6">
                    <label class="block text-600 text-sm font-bold mb-2">
                      เลือกยาวิตามิน
                    ...
                    <Dropdown
                      ...
                      optionValue="CureVitaminID"
                      :options="selection.CureVitamin"
                      v-model="form.CureVitaminName[item - 1]"
                    />
                    <!-- <Dropdown
                      class="w-full"
                      v-model="item.name"
                  ...
                  <div class="field col-6">
                    ...
                    <InputNumber
                      id="minmaxfraction"
                      v-model="form.CureVitaminValue[item - 1]"
                      mode="decimal"
                      :minFractionDigits="2"
                      :maxFractionDigits="5"
                      class="w-full"
          ...
          <div class="field col-12">
            <div class="field-checkbox">
              ...
              />
              <label for="cureByCleanUterus">รักษาโดยวิธีอื่น ๆ</label>
            </div>
            <div v-if="form.CureByOther == 1">
              <label class="block text-600 text-sm font-bold mb-2">
                หมายเหตุการรักษาโดยวิธีอื่น ๆ
...
export default {
  ...
  methods: {
    ...
    edit(id) {
      ...
      if (this.form.CureHormoneID) {
        for (let i = 0; i < this.form.CureHormoneID.length; i++) {
          ...
          this.form.CureHormoneName[i] = this.form.CureHormoneID[i][0];
          this.form.CureHormoneValue[i] = this.form.CureHormoneID[i][1];
        }
      }
      if (this.form.CureVitaminID) {
        for (let i = 0; i < this.form.CureVitaminID.length; i++) {
          this.cureByVitaminEdit += 1;
          this.form.CureVitaminName[i] = this.form.CureVitaminID[i][0];
          this.form.CureVitaminValue[i] = this.form.CureVitaminID[i][1];
        }
      }
      if (this.form.CureAntibioticID) {
        for (let i = 0; i < this.form.CureAntibioticID.length; i++) {
          this.cureByAntibioticEdit += 1;
          this.form.CureAntibioticName[i] = this.form.CureAntibioticID[i][0];
          this.form.CureAntibioticValue[i] = this.form.CureAntibioticID[i][1];
        }
      }

      this.form.CureByHormone = this.form.CureByHormone == 1 ? true : false;
      this.form.CureByVitamin = this.form.CureByVitamin == 1 ? true : false;
    ...
    async update() {
      ...
      this.form.CureByAntibiotic = this.form.CureByAntibiotic == true ? 1 : 0;
    ...
    deleteCureVitamin() {
      this.cureVitaminSettings.splice(this.cureVitaminSettings.length - 1, 1);
    },
    ...
    deleteCureByOther() {
      this.cureByOtherSettings.splice(this.cureByOtherSettings.length - 1, 1);
    },
