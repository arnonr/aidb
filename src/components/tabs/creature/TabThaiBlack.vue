<template>
  <div class="flex justify-content-between">
    <div class="text-xl">รายการโครงการทั้งหมด</div>
    <Button
      label="เพิ่มข้อมูล"
      icon="pi pi-plus"
      ...
      <div class="col-12 lg:col-12">
        <div class="formgrid grid">
          <div class="field col-12 sm:col-12 md:col-12">
            <label class="block text-600 text-sm font-bold mb-2"> สัตว์</label>
            <Dropdown
              class="w-full"
              id="selectedstatus"
          ...
          <div class="field col-12 sm:col-6 md:col-6">
            ...
            <!-- <Calendar
              ...
              :showButtonBar="true"
              :showIcon="true"
              v-model="form.ThaiThaiblackDate"
              :class="{ 'p-invalid': !form.ThaiThaiblackDate && valid }"
            /> -->
        ...
        .then((response) => {
          ...
          for (let i = 0; i < this.data.length; i++) {
            ...
            this.data[i].Fullname =
              this.data[i].Animal.AnimalEarID +
              ", " +
