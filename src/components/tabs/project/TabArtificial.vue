<template>
  <div class="grid flex align-items-center mt-3 mb-5">
    <div class="col-12 md:col-6">
      <h1 class="text-2xl mb-0 text-600">
        มีรายการผสมเทียมในโครงการทั้งหมด 2 รายการ
      </h1>
    </div>
    <div class="col-12 md:col-6 md:text-right">
      <router-link to="/project/artificial/add">
        <Button
          label="เพิ่ม AI เข้าโครงการ"
          icon="pi pi-plus"
  ...
  >
    ...
    <Column field="time" header="ครั้งที่ผสม" class="text-center"></Column>
    <Column field="child" header="รอบการให้นม" class="text-center"></Column>
    <Column field="date" header="วันที่ผสม" class="text-center"></Column>
    <Column field="water" header="หมายเลขน้ำเชื้อที่ใช้" class="text-center"></Column>
