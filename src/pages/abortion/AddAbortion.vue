<template>
    <div class="grid">
        <div class="col-12">
            <PageTitle title="เพิ่มการแท้ง" :pages="breadcrumb" />
...
export default {
    ...
    setup() {
        const breadcrumb = ref([
            ...
            { label: 'เพิ่มข้อมูลการแท้ง', to: '/activity/abortion/add' }, ///activity/abortion/add
        ])
        const router = useRouter()
        const steps = ref([
            {
                label: 'ข้อมูล',
                to: "/activity/abortion/add" ///activity/abortion/add
            },
            {
                label: 'ข้อมูลการแท้ง',
                to: "/activity/abortion/add/add-step2", ///activity/abortion/add/add-step2
            },
        ]);
