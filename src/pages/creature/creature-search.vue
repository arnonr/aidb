                        ...
                        <template #body="slotProps">
                            <div>
                                <span
                                    class="text-blue-400"
                                    @click="
                                        open_detail(slotProps.data.AnimalID)
                                    "
                                    ><u>{{
            ...
            <form class="grid mt-2">
                    ...
                    <div class="grid">
                        ...
                        <div class="col-12 sm:col-12 lg:col-8 grid">
                            ...
                            <div class="field col-12 sm:col-6">
                                ...
                                <span>
                                    {{
                                        form.AnimalStatus?.AnimalStatusName
                                    }}</span
                                >
                            </div>
                            ...
                            <div class="field col-12 sm:col-6">
                                <span> ชนิดสัตว์ : </span>
                                <span>
                                    {{ form.AnimalType.AnimalTypeName }}</span
                                >
                            </div>
                        </div>
                    </div>
              ...
              <span> {{ form.AnimalDateJoin }}</span>
                        ...
                        <div class="field col-12 sm:col-6">
                            ...
                            <span>
                                {{
                                    form.AnimalFarm.FarmIdentificationNumber
                                }}</span
                            >
                        </div>
                        ...
                        <div class="field col-12 sm:col-6">
                            ...
                            <span>
                                {{ form.AnimalFarm.AIZone.AIZoneName }}</span
                            >
                        </div>
    ...
    data() {
        return {
            ...
            url: {
                ...
                OrganizationType:
                    "/organization-type/selection?includeAll=false",
    ...
    methods: {
        ...
        async onExport() {
            this.exportExcel().then(() => {
                setTimeout(async () => {
                    ...
                    worksheet.insertRow(1, "รายการสัตว์");
                    worksheet.mergeCells("A1:K1");
                    worksheet.getCell("A1").value = "รายการทะเบียนสัตว์";
                    ...
                    link.href = href;
                    link.download = "รายการสัตว์.xlsx";
        ...
        setParam() {
            if (this.filtered.OrganizationZoneID) {
                this.params.OrganizationZoneID =
                    this.filtered.OrganizationZoneID;
            }
