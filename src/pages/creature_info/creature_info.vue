    ...
    <div class="grid">
        <div class="col-12">
            ...
            <div class="card" v-if="data.AnimalName">
                <div>
                    <h4 class="text-xl mb-0 text-600">
                        ข้อมูลหมายเลข {{ search }}
                    </h4>
                </div>
                <div class="grid mt-3">
...
export default {
    ...
    mounted() {
        ...
        this.AnimalNameGlobal =
            this.animal_id == 1 ? "โค" : this.animal_id == 2 ? "กระบือ" : "แพะ";
