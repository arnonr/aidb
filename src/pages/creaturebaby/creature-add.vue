    ...
    <div class="grid">
        ...
        >
            <div class="text-center text-teal-700 py-8">
                <img
                    src="..\..\assets\images\check-circle-fill.svg"
                    alt="icons"
                />
...
export default {
    ...
    mounted() {
        ...
        if (this.bornItem) {
            ...
            //
            this.showAnimalBirthDate = dayjs(
                this.bornItem.AnimalBirthDate
            ).format("DD/MM/BBBB");
    ...
    methods: {
        ...
        callStatus() {
            if (this.form.AnimalBirthDate && this.form.AnimalSexID) {
                let date = JSON.stringify(this.form.AnimalBirthDate);
            ...
            if (this.animal_id == 1) {
                ...
                console.log(this.animalstatus);
                    ...
                    if (totalday < 30 * 4) {
                        ...
                        this.animalstatus = this.animalstatusDefault.filter(
                            (x) => {
                                return x.AnimalStatusName === "โคสาว";
                            }
                        );
                    } else {
                        this.animalstatus = this.animalstatusDefault.filter(
        ...
        load() {
            ...
            axios
                .get(this.apiOrganizationZoneID, {
                    signal: this.controller.signal,
                })
                .then((response) => {
            ...
            if (this.animal_id == 1) {
                this.apiProject +=
                    "&ProjectLevel=ANIMAL&AnimalTypeID=[1,2,41,42]";
            } else if (this.animal_id == 2) {
                this.apiProject +=
                    "&ProjectLevel=ANIMAL&AnimalTypeID=[3,4,43,44]";
            } else if (this.animal_id == 3) {
                this.apiProject +=
