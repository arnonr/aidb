<template>
  <div class="grid">
    <div class="col-12">
      <PageTitle title="เพิ่มข้อมูลถ่ายพยาธิ" :pages="breadcrumb" />
      <div class="card">
        <form>
          <div class="mb-5">
            <h1 class="text-2xl mb-0 text-600">เพิ่มข้อมูลการถ่ายพยาธิ</h1>
          </div>
          <div v-if="loader" class="formgrid grid">
            ...
            <div class="field col-12 sm:col-6">
              <label class="block text-600 text-sm font-bold mb-2">
                วันที่การถ่ายพยาธิครั้งต่อไป<span class="text-red-500"> *</span>
              </label>
...
export default {
  ...
  methods: {
    ...
    add() {
      ...
      axios
        .post(this.postDewormActivity, this.form, {
          signal: this.controller.signal,
        })
        .then(() => {
          this.load();
