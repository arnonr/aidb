                  ...
                  <InputText class="w-full" type="text" v-model="value1" />
                        ...
                        <div class="field col-12 sm:col-4">
                            <label
                                class="block text-600 text-sm font-bold mb-2"
                            >
                                สาเหตุที่คัดจำหน่าย<span class="text-red-500">
                                    *</span
                                >
                            </label>
                            <Dropdown
                        ...
                        >
                            <label
                                class="block text-600 text-sm font-bold mb-2"
                            >
                                ฟาร์มปลายทางที่คัดจำหน่าย<span
                                    class="text-red-500"
                                >
                                    *</span
                                >
...
export default {
    ...
    methods: {
        ...
        async load() {
            this.isLoading = true;
            let url = this.url + "&size=" + this.rowPerPage;
            url += "&page=";
            if (this.curpage) {
                url += this.curpage;
            }
        ...
        fetchDistributionReason() {
            axios
                .get(this.urlDistributionReason, {
                    signal: this.controller.signal,
                })
                .then((res) => {
