                    ...
                    หมายเลขฟาร์ม
                            ...
                            <div class="field col-12 sm:col-6">
                                ...
                                <Dropdown
                                    ...
                                    :class="{
                                        'p-invalid': !form.VaccineID && valid,
                                    }"
                                    :showClear="true"
                            ...
                            <div class="field col-12 sm:col-4">
                                ...
                                <Datepicker
                                    ...
                                    :class="{
                                        'p-invalid':
                                            !form.VaccineActivityDate && valid,
                                    }"
                                    id="dateRange"
                                    locale="th"
                                    :format="format"
                          ...
                          {{ slotProps.option.StaffNumber }}
                            ...
                            <div class="field col-12 sm:col-6">
                                <label
                                    class="block text-600 text-sm font-bold mb-2"
                                >
                                    หน่วยงานที่ตรวจ<span class="text-red-500">
                                        *</span
                                    >
                                </label>
                                <Dropdown
                        ...
                        >
                            ...
                            >
                                <template #body="slotProps">
                                    <div
                                        v-for="item in animal_status.data"
                                        :key="item.id"
                                    >
                                        <div
                                            v-if="
                            ...
                            <Column header="จัดการ" class="text-center">
                                <template #body="slotProp">
                                    <Button
                                        icon="pi pi-eye"
                                        @click="
                                            openShowModal(slotProp.data.SemenID)
                                        "
...
export default {
    ...
    data() {
        return {
            ...
            url: {
                ...
                putVaccineActivity:
                    "/vaccine-activity/" + this.$route.params.id,
    ...
    methods: {
        ...
        async field() {
            ...
            await axios
                .get(this.url.putVaccineActivity, {
