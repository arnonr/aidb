            ...
            <div class="grid">
              ...
              >
                <div>
                  ...
                  {{ data.FarmAddress }} หมู่ที่ {{ data.FarmMoo }} ตำบล/แขวง
                  {{ data.Tumbol.TumbolName || "-" }} อำเภอ/เขต
  ...
  methods: {
    ...
    async load() {
      if (this.search.FarmID != null) {
        let url = "/farm/" + this.search.FarmID;
    ...
    fetchAnimal() {
      ...
      let params = { FarmID: this.search.FarmID, includeAnimalBreed: true };
