                            ...
                            <Column header="จัดการ" style="width: 200px">
                                <template #body="slotProps">
                                    <Button
                                        ...
                                        icon="pi pi-pencil"
                                        @click="
                                            editFarmer(slotProps.data.FarmID)
                                        "
        ...
        >
            ...
            <span class="font-semibold ml-2">
              {{
                ...
                <div class="col-12 lg:col-8">
                    <span class="font-medium text-700"
                        >วันที่ขึ้นทะเบียนเกษตรกร</span
                    >
                    <span class="font-semibold ml-2">
                        {{
                            detailInfo.Farmer &&
                            detailInfo.Farmer.FarmerRegisterDate != null
            ...
            <h5 class="text-xl mt-4 mb-4 font-light">
...
export default {
    ...
    methods: {
        editFarmer(id) {
            this.$router.push("/farm/edit/farmer-info/" + id);
        },
        mapProvincesTemp(id) {
            if (id != null) {
        ...
        mapAmphursTemp(id) {
            if (id != null) {
                return this.dropdown.Amphurs_temp.find(
                    (item) => item.AmphurID == id
                ).AmphurName;
            } else {
                return null;
            }
        ...
        mapTumbolsTemp(id) {
            console.log(id);
            if (id != null) {
                return this.dropdown.Tumbols_temp.find(
                    (item) => item.TumbolID == id
                ).TumbolName;
            } else {
                return id;
            }
        ...
        fetchFarm() {
            ...
            if (this.search.IdentificationNumber) {
                params["FarmerIdentificationNumber"] =
                    this.search.IdentificationNumber;
            }

            if (this.search.FarmerRegisterStatus) {
                params["FarmerRegisterStatus"] =
                    this.search.FarmerRegisterStatus;
            }
                ...
                .then((res) => {
                    this.data = res.data.rows
                        ...
                        .map((item) => {
                            ...
                            item.Farmer.FarmerRegisterDate = item.Farmer
                                .FarmerRegisterDate
