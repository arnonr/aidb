<template>
  <div class="grid">
    <div class="col-12">
      <PageTitle title="แก้ไขข้อมูลการขุน/อาหาร" :pages="breadcrumb" />
...
export default {
  ...
  setup() {
    const breadcrumb = ref([
      ...
      { label: "แก้ไขข้อมูลการขุน/อาหาร", to: "/activity/feed-profile/edit" },
    ]);
    const router = useRouter();
    const steps = ref([
      {
        label: "แก้ไขข้อมูลการขุน/อาหาร",
        to: "/activity/feed-profile/edit",
      },
      // {
      //   label: "ข้อมูลฟาร์ม",
      //   to: "/activity/feed-profile/edit/step1",
      // },
      // {
      //   label: "ข้อมูลรายละเอียดผสมเทียม",
      //   to: "/activity/feed-profile/edit/step2",
      // },
    ]);
