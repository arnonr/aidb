                ...
                <div class="grid">
                    <div class="col-12">
                        <div class="grid">
                            <div class="col-12 sm:col-6 lg:col-6 xl:col-6">
                                ...
                                >
                                    ชื่อโปรแกรม<span class="text-red-500">
                                        *</span
                                    >
                                </label>
                                <InputText
                    ...
                    <div class="col-12 sm:col-6 lg:col-6 xl:col-6">
                        <label
                            ...
                            class="block text-600 text-sm font-bold mb-2"
                        >
                            วันที่เริ่มขุน<span class="text-red-500">
                                *</span
                            ></label
                        >
                        <!-- <Calendar
    ...
    methods: {
        ...
        load() {
            ...
            axios
                ...
                .then((response) => {
                    this.selection.Staff = response.data.rows;
                })
                .finally(() => {
                    this.isLoading = false;
                });
