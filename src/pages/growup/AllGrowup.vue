<template>
  <div class="grid">
    <!-- start main page -->
    <div class="col-12">
      <PageTitle title="กิจกรรมการบันทึกการเจริญเติบโต" :pages="breadcrumb" />
      <div class="card">
        ...
        <div class="mt-5 card">
          <div class="flex justify-content-between">
            <div class="text-xl">ประวัติการบันทึกการเจริญเติบโต</div>
            <Button
              label="เพิ่มกิจกรรม"
              icon="pi pi-plus"
          ...
          >
            ...
            <Column
              ...
              class="text-center"
            ></Column>
            <Column field="a3" header="รอบอก(ซม.)" class="text-center"></Column>
            <Column
              field="a4"
              header="ส่วนสูง(ซม.)"
              class="text-center"
    ...
    <!-- Add Dialog -->
    <Dialog
      header="เพิ่มกิจการบันทึกการเจริญเติบโต"
    ...
    <!-- EDIT Dialog -->
    <Dialog
      header="แก้ไขกิจการบันทึกการเจริญเติบโต"
