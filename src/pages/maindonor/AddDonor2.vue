<template>
  <div class="grid">
    ...
    <div class="col-12">
      ...
      <div class="card mb-5">
        <h1 class="text-2xl mb-5 text-600">ข้อมูลแม่ตัวให้ (Donor)</h1>
        <DataTable
          class="text-sm"
          :value="selectItem"
      ...
      <div class="card">
        <div class="mb-5">
          <h2 class="text-2xl mb-0 text-600">เลือกโปรแกรมให้ตัวให้ (Donor)</h2>
        </div>
          ...
          <div class="col-12 lg:col-12">
            <div class="grid">
              ...
              <div class="col-12 lg:col-4">
                <label for="farm" class="block text-600 text-sm font-bold mb-2">
                  วันที่เก็บตัวอ่อน<span class="text-red-500"> *</span></label
                >
                <Calendar
                  class="w-full"
                  id="datebirth"
        ...
        <div class="mb-5 mt-5">
          <h4 class="text-2xl mb-0 text-600">รายละเอียดโปรแกรม</h4>
        </div>
        <DataTable
          class="text-sm"
          :value="setting"
          ...
          <div class="grid">
            ...
            <div class="col-12 lg:col-12">
              <label for="farm" class="block text-600 text-sm font-bold mb-2">
                กิจกรรม</label
              >
              <!-- <InputText v-model="formModel.Time" id="farm" class="w-full" /> -->
    ...
    >
      <div class="confirmation-content text-center">
        ...
        <br />
        <span class="text-xl">คุณต้องการลบรายการเตรียมแม่ตัวให้ใช่หรือไม่</span>
      </div>
      <template #footer>
  ...
  methods: {
    ...
    async add() {
      ...
      await axios
        ...
        .then((res) => {
          let donorid = res.data.DonorID;
          // console.log(res.data.DonorID);

          for (let i = 0; i < this.selectItem.length; i++) {
            let animalid = this.selectItem[i].AnimalID;

            for (let i = 0; i < this.setting.length; i++) {
              // console.log(this.setting[i].PresetDetailID);
