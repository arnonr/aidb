            ...
            <form class="grid mt-2">
                ...
                <div class="col-12">
                    ...
                    >
                        ...
                        ></Column>
                        <Column
                            field="WorkActivityDate"
                            header="วันที่ปฎิบัติการ (ว-ด-ป)"
                        >
                            <template #body="slotProps">
                                <div class="grid">
                                    <div class="col-6">
                                        <Calendar
                                            ...
                                            v-model="
                                                slotProps.data.WorkActivityDate
                                            "
                                            @date-select="
                                                fillDate(
                                                    $event,
                                ...
                                >
                                    ...
                                    <Checkbox
                                        ...
                                        @input="
                                            fillDone(
                                                $event,
                                                slotProps.data.DonorActivityID
                                            )
                                        "
                                    />
                                </div>
                    ...
                    <div class="formgrid grid">
                        ...
                        <div class="field col-12 sm:col-6">
                            ...
                            <Calendar
                                ...
                                :class="{
                                    'p-invalid': !formData.ExcludeDate && valid,
                                }"
                            />
                        </div>
                        ...
                        <div class="field col-12 sm:col-6">
                            ...
                            <Dropdown
                                ...
                                :class="{
                                    'p-invalid':
                                        !formData.ExcludeResponsibilityStaffID &&
                                        valid,
                                }"
                            />
                        </div>
            ...
            <form class="grid mt-2">
                <div class="col-12 lg:col-12">
                    <div class="formgrid grid">
                        ...
                        <h5
                            class="col-12"
                            v-if="this.form.InseminationTime > 0"
                        >
                            ผสมครั้งที่ 1
                        </h5>
                        <div
                        ...
                        >
                            ...
                            <Calendar
                                ...
                                :class="{
                                    'p-invalid': !form.SemenLot1 && valid,
                                }"
                            />
                        </div>
                        <div
                        ...
                        <h5
                            class="col-12"
                            v-if="this.form.InseminationTime > 1"
                        >
                            ผสมครั้งที่ 2
                        </h5>
                        <div
                        ...
                        >
                            ...
                            <Calendar
                                ...
                                :class="{
                                    'p-invalid': !form.SemenLot2 && valid,
                                }"
                            />
                        </div>
                        <div
                        ...
                        <h5
                            class="col-12"
                            v-if="this.form.InseminationTime > 2"
                        >
                            ผสมครั้งที่ 3
                        </h5>
                        <div
                        ...
                        >
                            ...
                            <Calendar
                                ...
                                :class="{
                                    'p-invalid': !form.SemenLot3 && valid,
                                }"
                            />
                        </div>
                        <div
                        ...
                        <h5
                            class="col-12"
                            v-if="this.form.InseminationTime > 3"
                        >
                            ผสมครั้งที่ 4
                        </h5>
                        <div
                        ...
                        >
                            ...
                            <Calendar
                                ...
                                :class="{
                                    'p-invalid': !form.SemenLot4 && valid,
                                }"
                            />
                        </div>
                        <div
                        ...
                        <h5
                            class="col-12"
                            v-if="this.form.InseminationTime > 4"
                        >
                            ผสมครั้งที่ 5
                        </h5>
                        <div
                        ...
                        >
                            ...
                            <Calendar
                                ...
                                :class="{
                                    'p-invalid': !form.SemenLot5 && valid,
                                }"
                            />
                        </div>
                        <div
    ...
    data() {
        return {
            ...
            GoatAIMethodID: [
                ...
                {
                    val: "AI",
                    name: "ผสมเทียมเป็นสัดธรรมชาติ (AI)",
                },
                {
                    val: "VAI",
    ...
    methods: {
        ...
        open_detail(donorid, animalid) {
            axios
                ...
                .then((response) => {
                    this.listActivity = response.data.rows.sort(function (
                        a,
                        b
                    ) {
                    ...
                    for (let i = 0; i < this.listActivity.length; i++) {
                        ...
                        this.listActivity[i].Time = this.listActivity[
                            i
                        ].Time.substring(0, 5);
                        ...
                        if (
                            this.listActivity[i].PresetActivity
                                .PresetActivityName == "AI1" ||
                            this.listActivity[i].PresetActivity
                                .PresetActivityName == "AI2" ||
                            this.listActivity[i].PresetActivity
                                .PresetActivityName == "AI3" ||
                            this.listActivity[i].PresetActivity
                                .PresetActivityName == "ผสม1" ||
                            this.listActivity[i].PresetActivity
                                .PresetActivityName == "ผสม2" ||
                            this.listActivity[i].PresetActivity
                                .PresetActivityName == "ผสม3"
                        ) {
        ...
        open_update(id) {
            if (id) {
                ...
                let temp = this.listActivity.find(
                    (x) => x.DonorActivityID == id
                );
                if (temp) {
            ...
            if (this.animal_id == 3) {
                axios
                    .get(
                        this.apiAnimal +
                            "?AnimalTypeID=[17,18]&AnimalStatusID=14",
                        {
                            signal: this.controller.signal,
                        }
                    )
        ...
        saveGoat() {
            ...
            this.form.AITime1
                ? (this.form.AITime1 = dayjs(this.form.AITime1).format(
                      "HH:mm:ss"
                  ))
                : null;
            this.form.AITime2
                ? (this.form.AITime2 = dayjs(this.form.AITime2).format(
                      "HH:mm:ss"
                  ))
                : null;
            this.form.AITime3
                ? (this.form.AITime3 = dayjs(this.form.AITime3).format(
                      "HH:mm:ss"
                  ))
                : null;
            this.form.AITime4
                ? (this.form.AITime4 = dayjs(this.form.AITime4).format(
                      "HH:mm:ss"
                  ))
                : null;
            this.form.AITime5
                ? (this.form.AITime5 = dayjs(this.form.AITime5).format(
                      "HH:mm:ss"
                  ))
                : null;
            ...
            axios
                .put(
                    this.apiDetailActivity + "/" + this.DonorActivityID,
                    this.form
                )
                .then(() => {
                    // console.log(res);
