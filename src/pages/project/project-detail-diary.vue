    ...
    <div class="grid">
        ...
        <div class="col-12">
            ...
            <div class="field col-12 sm:col-12 md:col-12">
                <router-link
                    :to="'/project/detail?projects=' + search.ProjectIDArray"
                >
                    <Button severity="secondary" label="ทะเบียนฟาร์ม" />
                </router-link>
                <router-link
                    :to="
                        '/project/detail-animal?projects=' +
                ...
                <router-link
                    :to="
                        '/project/detail-diary?projects=' +
                        search.ProjectIDArray
                    "
                >
                    <Button
                        severity="primary"
                        label="กิจกรรมแจ้งเตือน"
                        class="ml-2"
                    />
                </router-link>
                <router-link
            ...
            <div class="card">
                <div class="grid align-items-center mb-6 xl:px-8">
                    <div class="col-12 md:col-6 xl:col-8">
                        <h1
                            class="text-2xl sm:text-4xl mb-0 text-indigo-800 font-semibold"
                        >
        ...
        async load() {
            ...
            await axios
                ...
                .then(async (response) => {
                    ...
                    check1.alert = response.data.noti.noti1;
                    check1.AnimalID = response.data.noti.noti1Animal;

                    let check2 = this.noti.find((x) => {
                        return x.id == 2;
                    });
                    check2.alert = response.data.noti.noti2;
                    check2.AnimalID = response.data.noti.noti2Animal;

                    let check3 = this.noti.find((x) => {
                        return x.id == 3;
                    });
                    check3.alert = response.data.noti.noti3;
                    check3.AnimalID = response.data.noti.noti3Animal;

                    let check4 = this.noti.find((x) => {
                        return x.id == 4;
                    });
                    check4.alert = response.data.noti.noti4;
                    check4.AnimalID = response.data.noti.noti4Animal;

                    let check5 = this.noti.find((x) => {
                        return x.id == 5;
                    });
                    check5.alert = response.data.noti.noti5;
                    check5.AnimalID = response.data.noti.noti5Animal;

                    let check6 = this.noti.find((x) => {
                        return x.id == 6;
                    });
                    ...
                    check7.alert = response.data.noti.noti7;
                    check7.AnimalID = response.data.noti.noti7Animal;

                    let check8 = this.noti.find((x) => {
                        return x.id == 8;
                    });
                    check8.alert = response.data.noti.noti8;
                    check8.AnimalID = response.data.noti.noti8Animal;

                    let check9 = this.noti.find((x) => {
                        return x.id == 9;
                    });
                    check9.alert = response.data.noti.noti9;
                    check9.AnimalID = response.data.noti.noti9Animal;

                    let check10 = this.noti.find((x) => {
                        return x.id == 10;
                    });
                    check10.alert = response.data.noti.noti10;
                    check10.AnimalID = response.data.noti.noti10Animal;
                    ...
                    //     .noti2Animal;
                    // this.noti[2].alert = await response.data.noti.noti3;
                    // this.noti[2].AnimalID = await response.data.noti
                    //     .noti3Animal;
                    // this.noti[3].alert = await response.data.noti.noti4;
                    // this.noti[3].AnimalID = await response.data.noti
                    //     .noti4Animal;
                    // this.noti[4].alert = await response.data.noti.noti5;
                    // this.noti[4].AnimalID = await response.data.noti
                    //     .noti5Animal;
                    // this.noti[5].alert = await response.data.noti.noti6;
                    // this.noti[5].AnimalID = await response.data.noti
                    //     .noti6Animal;
                    // this.noti[6].alert = await response.data.noti.noti7;
                    // this.noti[6].AnimalID = await response.data.noti
                    //     .noti7Animal;
                    // this.noti[7].alert = await response.data.noti.noti8;
                    // this.noti[7].AnimalID = await response.data.noti
                    //     .noti8Animal;

                    // this.noti.sor;

                    // console.log(response.data.noti.noti1);
