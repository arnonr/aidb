    ...
    methods: {
        ...
        async add() {
            ...
            for (let i = 0; i < this.form.AnimalID.length; i++) {
                ...
                await axios
                    .post(this.postThaiblack, {
                        AnimalID: this.form.AnimalID[i],
                        ThaiblackDate: this.form.ThaiblackDate,
                        ResponsibilityStaffID: this.form.ResponsibilityStaffID,
                        ThaiblackRound: this.form.ThaiblackRound,
        ...
        onSelectionChange(event) {
            console.log(event);
            // this.selectedIds = event.value.map((item) => item.id);
