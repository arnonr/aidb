<template>
  <div class="grid">
    <!-- start main page -->
    <div class="col-12">
      <PageTitle title="สรุปรายงานรายงานติดตามลูกเกิด"  />
      ...
      <div class="card">
        <div class="grid flex align-items-center mb-5">
          <div class="col-12 md:col-6">
            <h1 class="text-2xl mb-0 text-600">
              สรุปภาพรวมของรายงานติดตามลูกเกิด
            </h1>
          </div>
        ...
        <div class="mt-5">
          ...
          >
            ...
            <Column
              field="gender9"
              header="วันที่ติดตามหรือวันคลอดจริง"
              class="text-center"
            ></Column>
            <Column
              field="gender10"
...
export default {
  ...
  setup() {
    ...
    //   { label: "ทะเบียน", to: "/" },
    //   { label: "ทะเบียนน้ำเชื้อ", to: "/sperm" },
    // ]);
    // const data = reactive([
    //   {
    //     id: "887",
