<template>
  <div class="grid">
    ...
    <!-- <div class="col-12 xl:col-4">
      <div class="card">
        ...
        <DataTable :value="data.sub1" :rows="10" responsiveLayout="scroll">
          <Column field="key" header="#" class="text-center"> </Column>
          <Column field="value" header="ชื่อฟาร์ม" class="text-center">
          </Column>
        </DataTable>
      </div>
    </div>
    ...
    <div class="col-12 xl:col-4">
      <div class="card">
        <h5>จำนวนตัว</h5>
        <Chart type="pie" :data="Chart1" :options="pieOptions" class="w-full" />
      </div>
    </div> -->
    ...
    <div class="col-12 xl:col-6">
      <div class="card">
        <h5>จำนวนประชากร{{ localAnimal }}</h5>
        <DataTable :value="sub" :rows="10" responsiveLayout="scroll">
          <Column
            field="key"
            header="ประเภท"
            class="text-center"
...
export default {
  ...
  data() {
    return {
      ...
      loading: false,
      Chart: {
        labels: ["แม่โค", "สาวโค", "ลูกโค", "พ่อพันธุ์"],
        datasets: [
          {
            data: [300, 50, 100, 20],
            backgroundColor: ["#42A5F5", "#66BB6A", "#FFA726", "#593e25"],
            hoverBackgroundColor: ["#64B5F6", "#81C784", "#FFB74D", "#593e25"],
          },
        ],
      },
      Chart2: {
