<template>
  <div class="grid">
    <div class="col-12">
      <PageTitle title="รายงานการเจริญเติบโต" />
      <!-- <div class="card">
    ...
    <div class="col-12 xl:col-12">
      <div class="card">
        ...
        <h5 class="text-center">รายงานการเจริญเติบโต</h5>
        ...
        .then((res) => {
          ...
          this.data = res.data.map((item) => {
            return {
              ...
              ThaiCheckupDate: item.ThaiCheckupDate,
              Weight: item.Weight,
              Height: item.Height,
              PerimeterChest: item.PerimeterChest,
              PerimeterBall: item.PerimeterBall,
            };
          });
        })
        .finally(() => {
