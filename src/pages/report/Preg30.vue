        ...
        >
          ...
          <template #expansion="slotProps">
            <div class="orders-subtable">
              ...
              <DataTable :value="slotProps.data.GiveBirth" responsiveLayout="scroll">
                <Column
                  field="AnimalEarID"
                  header="หมายเลขใบหู"
                  sortable
                ...
                <Column field="ThaiGiveBirthDate" header="วันที่คลอด" sortable></Column>
                <Column field="TimeNo" header="ครั้งที่" sortable></Column>
                <Column field="ThaiAIDate" header="วันที่ผสมเทียม" sortable></Column>
                <Column field="ThaiReproduceDate" header="วันที่ตรวจ" sortable></Column>
                <Column field="Symptom" header="ครั้งที่" sortable></Column>
                <Column field="Cure" header="ครั้งที่" sortable></Column>
                <Column field="BCS" header="ครั้งที่" sortable></Column>
                <Column field="TimeNo" header="ครั้งที่" sortable></Column>
                
              
                <Column
                  field="ResponsibilityStaff"
                  header="ผู้ตรวจ"
                  sortable
                ></Column>
              </DataTable>
...
export default {
  ...
  data() {
    return {
      title: "รายงานตรวจระบบสืบพันธ์หลังคลอด 30 วัน",
      data: [],
      url: {
