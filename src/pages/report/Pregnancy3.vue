        ...
        fetchReport() {
            ...
            axios
                ...
                .then((res) => {
                    ...
                    if (this.data.main.length != 0) {
                        this.data.main.forEach((x) => {
                            this.totalStatus.farm =
                                this.totalStatus.farm + x.FarmCount;
                            x.AnimalID.forEach((e) => {
                                AnimalIDAll.push(e);
                                this.totalStatus.all = this.totalStatus.all + 1;
                                this.totalStatus.child =
                                    this.totalStatus.child + e.Amount;

                                if (e.ChildGender.includes("M")) {
                                    this.totalStatus.male =
                                        this.totalStatus.male + 1;
                                }
                                if (e.ChildGender.includes("F")) {
                                    this.totalStatus.female =
                                        this.totalStatus.female + 1;
                                }
                            });
                        });
                    }
