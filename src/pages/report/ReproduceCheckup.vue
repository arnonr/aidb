  ...
  <div class="grid">
    ...
    <div class="col-12 xl:col-12">
      <div class="card">
        ...
        <h5 class="text-center">รายงานแก้ไขปัญหาทางระบบสืบพันธุ์</h5>
...
export default {
  ...
  data() {
    return {
      title: "รายงานแก้ไขปัญหาทางระบบสืบพันธุ์",
      data: [],
      url: {
        ...
        .then((res) => {
          ...
          this.data = res.data.map((item) => {
            return {
              ...
              PAR: item.PAR,
              ThaiReproduceDate: item.ThaiReproduceDate,
              FarmerRemark: item.FarmerRemark,
              Symptom: item.Symptom,
              Cure: item.Cure,
              result: item.result,
              BCS: item.BCS,
              ResponsibilityStaff: item.ResponsibilityStaff,
            };
          });
        })
        .finally(() => {
