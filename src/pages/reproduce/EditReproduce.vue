<template>
    <div class="grid">
        <div class="col-12">
            <PageTitle title="แก้ไขการตรวจระบบสืบพันธุ์" :pages="breadcrumb" />
...
export default {
    ...
    setup() {
        const breadcrumb = ref([
            { label: 'กิจกรรมการแท้ง', to: '/activity/abortion/all' }, ///activity/abortion/all
            { label: 'แก้ไขข้อมูลการแท้ง', to: '/activity/abortion/edit' }, ///activity/abortion/add
        ])
        const router = useRouter()
        const steps = ref([
            {
                label: 'ข้อมูลกระบือ',
                to: "/reproduce/edit" ///activity/abortion/add
            },
            {
                label: "ประวัติทั่วไป",
                to: "/reproduce/edit/detail",
            },
            {
                label: "สรุปผลการตรวจวินิจฉัย",
                to:"/reproduce/edit/diagnose",
            },
            {
                label: "สาเหตุโน้มนำ",
                to:"/reproduce/edit/cause",
            },
            {
                label: "การรักษา",
                to:"/reproduce/edit/treatment",
            },
            {
                label: "คำแนะนำ",
                to:"/reproduce/edit/Suggestion",
            },
