<template>
  <div class="grid">
    <!-- start main page -->
    <div class="col-12">
      <PageTitle title="ลักษณะการแท้ง" :pages="breadcrumb" />
      ...
      <div class="mt-5 card">
        <div class="grid flex align-items-center mb-5">
          <div class="col-12 md:col-6">
            <h1 class="text-2xl mb-0 text-600">ลักษณะการแท้ง</h1>
          </div>
        ...
        >
          ...
          ></Column>
          <Column
            field="AbortResultCode"
            header="รหัสลักษณะการแท้ง"
            class="text-center"
            :sortable="true"
          ></Column>
          <Column
            field="AbortResultName"
            header="ชื่อลักษณะการแท้ง"
            class="text-center"
            :sortable="true"
          ></Column>
          ...
          <div class="formgrid grid">
            <div class="field col-12 sm:col-12">
              <label class="block text-sm font-bold mb-2"
                >รหัสลักษณะการแท้ง</label
              >
              <InputText
                type="text"
                class="w-full"
                :class="{ 'p-invalid': !form.AbortResultCode && valid }"
                v-model="form.AbortResultCode"
              />
            </div>
            ...
            <div class="field col-12 sm:col-12">
              ...
              <InputText
                type="text"
                class="w-full"
                v-model="form.AbortResultName"
                :class="{ 'p-invalid': !form.AbortResultName && valid }"
              />
            </div>
...
export default {
  ...
  methods: {
    ...
    validation() {
      if (!this.form.AbortResultCode || !this.form.AbortResultName) {
        this.valid = true;
        this.$toast.add({
          severity: "error",
          summary: "ล้มเหลว",
    ...
    open_edit(id) {
      ...
      this.form = {
        ...
        AbortResultCode: id.AbortResultCode,
        AbortResultName: id.AbortResultName,
        AbortResultNameEN: id.AbortResultNameEN,
        show_id: id.show_id,
