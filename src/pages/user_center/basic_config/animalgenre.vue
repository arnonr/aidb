<template>
  <div class="grid">
    <!-- start main page -->
    <div class="col-12">
      <PageTitle title="ประเภทสัตว์" :pages="breadcrumb" />
      ...
      <div class="mt-5 card">
        <div class="grid flex align-items-center mb-5">
          <div class="col-12 md:col-6">
            <h1 class="text-2xl mb-0 text-600">ประเภทสัตว์</h1>
          </div>
        ...
        >
          ...
          ></Column>
          <Column
            field="AnimalGenreCode"
            header="รหัสประเภทสัตว์"
            class="text-center"
            :sortable="true"
          ></Column>
          <Column
            field="AnimalGenreName"
            header="ชื่อประเภทสัตว์"
            class="text-center"
            :sortable="true"
          ></Column>
          ...
          <Column header="จัดการ" class="text-center">
            <template #body="slotProps">
              <Button
                ...
                @click="open_edit(slotProps.data.AnimalGenreID)"
              />
              <Button
                label="ลบ"
                icon="pi pi-trash"
          ...
          <div class="formgrid grid">
            <div class="field col-12 sm:col-12">
              <label class="block text-sm font-bold mb-2"
                >รหัสประเภทสัตว์</label
              >
              <InputText
                type="text"
                class="w-full"
                :class="{ 'p-invalid': !form.AnimalGenreCode && valid }"
                v-model="form.AnimalGenreCode"
              />
            </div>
            ...
            <div class="field col-12 sm:col-12">
              ...
              <InputText
                type="text"
                class="w-full"
                v-model="form.AnimalGenreName"
                :class="{ 'p-invalid': !form.AnimalGenreName && valid }"
              />
            </div>
...
export default {
  ...
  methods: {
    ...
    validation() {
      if (!this.form.AnimalGenreCode || !this.form.AnimalGenreName) {
        this.valid = true;
        this.$toast.add({
          severity: "error",
          summary: "ล้มเหลว",
    ...
    update() {
      ...
      this.form.isActive = this.form.isActive.value;
      axios
        .put(this.url + "/" + this.form.AnimalGenreID, this.form)
        .then(() => {
          this.close_edit();
          this.load();
          this.$toast.add({
    ...
    open_edit(id) {
      id = this.data.find((x) => x.AnimalGenreID == id);
      if (id.isActive == 0) {
      ...
      this.form = {
        ...
        AnimalGenreCode: id.AnimalGenreCode,
        AnimalGenreName: id.AnimalGenreName,
        AnimalGenreNameEN: id.AnimalGenreNameEN,
        show_id: id.show_id,
