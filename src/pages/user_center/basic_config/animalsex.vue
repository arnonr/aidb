<template>
  <div class="grid">
    <!-- start main page -->
    <div class="col-12">
      <PageTitle title="เพศของสัตว์" :pages="breadcrumb" />
      ...
      <div class="mt-5 card">
        <div class="grid flex align-items-center mb-5">
          <div class="col-12 md:col-6">
            <h1 class="text-2xl mb-0 text-600">เพศของสัตว์</h1>
          </div>
        ...
        >
          ...
          <Column
            field="AnimalSexCode"
            header="รหัสเพศของสัตว์"
            class="text-center"
            :sortable="true"
          ></Column>
          <Column
            field="AnimalSexName"
            header="ชื่อเพศของสัตว์"
            class="text-center"
            :sortable="true"
          ></Column>
          ...
          <Column header="จัดการ" class="text-center">
            <template #body="slotProps">
              <Button
                ...
                @click="open_edit(slotProps.data.AnimalSexID)"
              />
              <Button
                label="ลบ"
                icon="pi pi-trash"
          ...
          <div class="formgrid grid">
            <div class="field col-12 sm:col-12">
              <label class="block text-sm font-bold mb-2"
                >รหัสเพศของสัตว์</label
              >
              <InputText
                type="text"
                class="w-full"
                :class="{ 'p-invalid': !form.AnimalSexCode && valid }"
                v-model="form.AnimalSexCode"
              />
            </div>
            ...
            <div class="field col-12 sm:col-12">
              ...
              <InputText
                type="text"
                class="w-full"
                v-model="form.AnimalSexName"
                :class="{ 'p-invalid': !form.AnimalSexName && valid }"
              />
            </div>
...
export default {
  ...
  methods: {
    ...
    validation() {
      if (!this.form.AnimalSexCode || !this.form.AnimalSexName) {
        this.valid = true;
        this.$toast.add({
          severity: "error",
          summary: "ล้มเหลว",
    ...
    update() {
      ...
      this.form.isActive = this.form.isActive.value;
      axios
        .put(this.url + "/" + this.form.AnimalSexID, this.form)
        .then(() => {
          this.close_edit();
          this.load();
          this.$toast.add({
    ...
    open_edit(id) {
      id = this.data.find((x) => x.AnimalSexID == id);
      if (id.isActive == 0) {
      ...
      this.form = {
        ...
        AnimalSexCode: id.AnimalSexCode,
        AnimalSexName: id.AnimalSexName,
        AnimalSexNameEN: id.AnimalSexNameEN,
        show_id: id.show_id,
