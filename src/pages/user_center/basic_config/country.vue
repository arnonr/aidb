<template>
  <div class="grid">
    <!-- start main page -->
    <div class="col-12">
      <PageTitle title="ประเทศ" :pages="breadcrumb" />
      ...
      <div class="mt-5 card">
        <div class="grid flex align-items-center mb-5">
          <div class="col-12 md:col-6">
            <h1 class="text-2xl mb-0 text-600">ประเทศ</h1>
          </div>
        ...
        >
          ...
          <Column
            field="CountryName"
            header="ชื่อประเทศ (ภาษาไทย)"
            class="text-center"
            :sortable="true"
          ></Column>
          <Column
            field="CountryNameEN"
            header="ชื่อประเทศ (ภาษาอังกฤษ)"
            class="text-center"
            :sortable="true"
          ></Column>
          ...
          <Column header="จัดการ" class="text-center">
            <template #body="slotProps">
              <Button
                ...
                @click="open_edit(slotProps.data.CountryID)"
              />
              <Button
                label="ลบ"
                icon="pi pi-trash"
                ...
                @click="
                  open_delete(slotProps.data.CountryID, slotProps.data.show_id)
                "
              />
            </template>
          </Column>
        ...
        <div class="col-12 lg:col-12">
          <div class="formgrid grid">
            <div class="field col-12 sm:col-12">
              <label class="block text-sm font-bold mb-2">รหัสประเทศ</label>
              <InputText
                type="text"
                class="w-full"
                :class="{ 'p-invalid': !form.CountryCode && valid }"
            ...
            <div class="field col-12 sm:col-12">
              ...
              <InputText
                ...
                :class="{ 'p-invalid': !form.CountryName && valid }"
              />
            </div>
            ...
            <div class="field col-12 sm:col-12">
              ...
              <InputText
                type="text"
                class="w-full"
                v-model="form.CountryNameEN"
                :class="{ 'p-invalid': !form.CountryNameEN && valid }"
              />
            </div>
...
export default {
  ...
  methods: {
    ...
    validation() {
      if (!this.form.CountryCode || !this.form.CountryName) {
        this.valid = true;
        this.$toast.add({
          severity: "error",
          summary: "ล้มเหลว",
    ...
    update() {
      ...
      this.form.isActive = this.form.isActive.value;
      axios
        .put(this.url + "/" + this.form.CountryID, this.form)
        .then(() => {
          this.close_edit();
          this.load();
          this.$toast.add({
    ...
    open_edit(id) {
      id = this.data.find((x) => x.CountryID == id);
      if (id.isActive == 0) {
      ...
      this.form = {
        ...
        CountryNameEN: id.CountryNameEN,
        show_id: id.show_id,
