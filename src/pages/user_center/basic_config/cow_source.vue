<template>
  <div class="grid">
    <!-- start main page -->
    <div class="col-12">
      <PageTitle title="แหล่งที่มา" :pages="breadcrumb" />
      ...
      <div class="mt-5 card">
        <div class="grid flex align-items-center mb-5">
          <div class="col-12 md:col-6">
            <h1 class="text-2xl mb-0 text-600">แหล่งที่มา</h1>
          </div>
        ...
        >
          ...
          <Column
            ...
            header="รหัสแหล่งที่มา"
            class="text-center"
            :sortable="true"
          ></Column>
          <Column
            field="SourceTypeName"
            header="ชื่อแหล่งที่มา"
            class="text-center"
            :sortable="true"
          ></Column>
          ...
          <Column header="จัดการ" class="text-center">
            <template #body="slotProps">
              <Button
                ...
                @click="open_edit(slotProps.data.SourceTypeID)"
              />
              <Button
                label="ลบ"
                icon="pi pi-trash"
        ...
        <div class="col-12 lg:col-12">
          <div class="formgrid grid">
            <div class="field col-12 sm:col-12">
              <label class="block text-sm font-bold mb-2">รหัสแหล่งที่มา</label>
              <InputText
                type="text"
                class="w-full"
                :class="{ 'p-invalid': !form.SourceTypeCode && valid }"
                v-model="form.SourceTypeCode"
              />
            </div>
            ...
            <div class="field col-12 sm:col-12">
              ...
              <InputText
                ...
                :class="{ 'p-invalid': !form.SourceTypeName && valid }"
              />
            </div>
...
export default {
  ...
  methods: {
    ...
    validation() {
      if (!this.form.SourceTypeCode || !this.form.SourceTypeName) {
        this.valid = true;
        this.$toast.add({
          severity: "error",
          summary: "ล้มเหลว",
    ...
    update() {
      ...
      this.form.isActive = this.form.isActive.value;
      axios
        .put(this.url + "/" + this.form.SourceTypeID, this.form)
        .then(() => {
          this.close_edit();
          this.load();
          this.$toast.add({
    ...
    open_edit(id) {
      id = this.data.find((x) => x.SourceTypeID == id);
      if (id.isActive == 0) {
      ...
      this.form = {
        SourceTypeID: id.SourceTypeID,
        SourceTypeCode: id.SourceTypeCode,
        SourceTypeName: id.SourceTypeName,
        SourceTypeNameEN: id.SourceTypeNameEN,
        show_id: id.show_id,
