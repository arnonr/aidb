<template>
  <div class="grid">
    <!-- start main page -->
    <div class="col-12">
      <PageTitle title="ข้อมูลสาเหตุการคัดจำหน่าย" :pages="breadcrumb" />
      ...
      <div class="mt-5 card">
        <div class="grid flex align-items-center mb-5">
          <div class="col-12 md:col-6">
            <h1 class="text-2xl mb-0 text-600">ข้อมูลสาเหตุการคัดจำหน่าย</h1>
          </div>
        ...
        >
          ...
          <Column
            field="name"
            :sortable="true"
            header="ข้อมูลสาเหตุการคัดจำหน่าย"
            class="text-center"
          ></Column>
          <Column
            field="is_active"
...
export default {
  ...
  data() {
    return {
      url: "/distribution-cause",
      breadcrumb: [
        { label: "ข้อมูลพื้นฐานระบบ", to: "/user_center/dashboard" },
        { label: "ข้อมูลสาเหตุการคัดจำหน่าย", to: "" },
      ],
      search: {
