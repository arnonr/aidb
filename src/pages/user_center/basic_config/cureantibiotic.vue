<template>
  <div class="grid">
    <!-- start main page -->
    <div class="col-12">
      <PageTitle title="ยาปฏิชีวนะ" :pages="breadcrumb" />
      ...
      <div class="mt-5 card">
        <div class="grid flex align-items-center mb-5">
          <div class="col-12 md:col-6">
            <h1 class="text-2xl mb-0 text-600">ยาปฏิชีวนะ</h1>
          </div>
        ...
        >
          ...
          ></Column>
          <Column
            field="CureAntibioticCode"
            header="รหัสยาปฏิชีวนะ"
            class="text-center"
            :sortable="true"
          ></Column>
          <Column
            field="CureAntibioticName"
            header="ชื่อยาปฏิชีวนะ"
            class="text-center"
            :sortable="true"
          ></Column>
          ...
          <Column header="จัดการ" class="text-center">
            <template #body="slotProps">
              <Button
                ...
                @click="open_edit(slotProps.data.CureAntibioticID)"
              />
              <Button
                label="ลบ"
                icon="pi pi-trash"
                ...
                @click="
                  open_delete(
                    slotProps.data.CureAntibioticID,
        ...
        <div class="col-12 lg:col-12">
          <div class="formgrid grid">
            <div class="field col-12 sm:col-12">
              <label class="block text-sm font-bold mb-2">รหัสยาปฏิชีวนะ</label>
              <InputText
                type="text"
                class="w-full"
                :class="{ 'p-invalid': !form.CureAntibioticCode && valid }"
                v-model="form.CureAntibioticCode"
              />
            </div>
            ...
            <div class="field col-12 sm:col-12">
              ...
              <InputText
                type="text"
                class="w-full"
                v-model="form.CureAntibioticName"
                :class="{ 'p-invalid': !form.CureAntibioticName && valid }"
              />
            </div>
            <div class="field col-12 sm:col-12">
...
export default {
  ...
  methods: {
    ...
    validation() {
      if (!this.form.CureAntibioticCode || !this.form.CureAntibioticName) {
        this.valid = true;
        this.$toast.add({
          severity: "error",
          summary: "ล้มเหลว",
    ...
    update() {
      ...
      this.form.isActive = this.form.isActive.value;
      axios
        .put(this.url + "/" + this.form.CureAntibioticID, this.form)
        .then(() => {
          this.close_edit();
          this.load();
          this.$toast.add({
    ...
    open_edit(id) {
      id = this.data.find((x) => x.CureAntibioticID == id);
      if (id.isActive == 0) {
      ...
      this.form = {
        CureAntibioticID: id.CureAntibioticID,
        CureAntibioticCode: id.CureAntibioticCode,
        CureAntibioticName: id.CureAntibioticName,
