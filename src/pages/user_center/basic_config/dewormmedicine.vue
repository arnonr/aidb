<template>
  <div class="grid">
    <!-- start main page -->
    <div class="col-12">
      <PageTitle title="ยาถ่ายพยาธิ" :pages="breadcrumb" />
      ...
      <div class="mt-5 card">
        <div class="grid flex align-items-center mb-5">
          <div class="col-12 md:col-6">
            <h1 class="text-2xl mb-0 text-600">ยาถ่ายพยาธิ</h1>
          </div>
        ...
        >
          ...
          ></Column>
          <Column
            field="DewormMedicineCode"
            header="รหัสยาถ่ายพยาธิ"
            class="text-center"
            :sortable="true"
          ></Column>
          <Column
          ...
          <Column header="จัดการ" class="text-center">
            <template #body="slotProps">
              <Button
                ...
                @click="open_edit(slotProps.data.DewormMedicineID)"
              />
              <Button
                label="ลบ"
                icon="pi pi-trash"
                ...
                @click="
                  open_delete(
                    slotProps.data.DewormMedicineID,
          ...
          <div class="formgrid grid">
            <div class="field col-12 sm:col-12">
              <label class="block text-sm font-bold mb-2"
                >รหัสยาถ่ายพยาธิ</label
              >
              <InputText
                type="text"
                class="w-full"
                :class="{ 'p-invalid': !form.DewormMedicineCode && valid }"
                v-model="form.DewormMedicineCode"
              />
            </div>
            ...
            <div class="field col-12 sm:col-12">
              ...
              <InputText
                type="text"
                class="w-full"
                v-model="form.DewormMedicineName"
                :class="{ 'p-invalid': !form.DewormMedicineName && valid }"
              />
            </div>
            <div class="field col-12 sm:col-12">
...
export default {
  ...
  methods: {
    ...
    validation() {
      if (!this.form.DewormMedicineCode || !this.form.DewormMedicineName) {
        this.valid = true;
        this.$toast.add({
          severity: "error",
          summary: "ล้มเหลว",
    ...
    update() {
      ...
      this.form.isActive = this.form.isActive.value;
      axios
        .put(this.url + "/" + this.form.DewormMedicineID, this.form)
        .then(() => {
          this.close_edit();
          this.load();
          this.$toast.add({
    ...
    open_edit(id) {
      id = this.data.find((x) => x.DewormMedicineID == id);
      if (id.isActive == 0) {
      ...
      this.form = {
        DewormMedicineID: id.DewormMedicineID,
        DewormMedicineCode: id.DewormMedicineCode,
        DewormMedicineName: id.DewormMedicineName,
