<template>
  <div class="grid">
    <!-- start main page -->
    <div class="col-12">
      <PageTitle title="ข้อมูลโรค" :pages="breadcrumb" />
      ...
      <div class="mt-5 card">
        <div class="grid flex align-items-center mb-5">
          <div class="col-12 md:col-6">
            <h1 class="text-2xl mb-0 text-600">ข้อมูลโรค</h1>
          </div>
        ...
        >
          ...
          <Column
            field="DiseaseCode"
            header="รหัสข้อมูลโรค"
            class="text-center"
            :sortable="true"
          ></Column>
          <Column
            field="DiseaseName"
            header="ชื่อข้อมูลโรค"
            class="text-center"
            :sortable="true"
          ></Column>
          ...
          <Column header="จัดการ" class="text-center">
            <template #body="slotProps">
              <Button
                ...
                @click="open_edit(slotProps.data.DiseaseID)"
              />
              <Button
                label="ลบ"
                icon="pi pi-trash"
                ...
                @click="
                  open_delete(slotProps.data.DiseaseID, slotProps.data.show_id)
                "
              />
            </template>
          </Column>
        ...
        <div class="col-12 lg:col-12">
          <div class="formgrid grid">
            <div class="field col-12 sm:col-12">
              <label class="block text-sm font-bold mb-2">รหัสข้อมูลโรค</label>
              <InputText
                type="text"
                class="w-full"
                :class="{ 'p-invalid': !form.DiseaseCode && valid }"
            ...
            <div class="field col-12 sm:col-12">
              ...
              <InputText
                ...
                :class="{ 'p-invalid': !form.DiseaseName && valid }"
              />
            </div>
            <div class="field col-12 sm:col-12">
...
export default {
  ...
  methods: {
    ...
    validation() {
      if (!this.form.DiseaseCode || !this.form.DiseaseName) {
        this.valid = true;
        this.$toast.add({
          severity: "error",
          summary: "ล้มเหลว",
    ...
    update() {
      ...
      this.form.isActive = this.form.isActive.value;
      axios
        .put(this.url + "/" + this.form.DiseaseID, this.form)
        .then(() => {
          this.close_edit();
          this.load();
          this.$toast.add({
    ...
    open_edit(id) {
      id = this.data.find((x) => x.DiseaseID == id);
      if (id.isActive == 0) {
      ...
      this.form = {
        ...
        DiseaseCode: id.DiseaseCode,
        DiseaseName: id.DiseaseName,
