<template>
  <div class="grid">
    <!-- start main page -->
    <div class="col-12">
      <PageTitle title="ทำงานด้าน" :pages="breadcrumb" />
      ...
      <div class="mt-5 card">
        <div class="grid flex align-items-center mb-5">
          <div class="col-12 md:col-6">
            <h1 class="text-2xl mb-0 text-600">ทำงานด้าน</h1>
          </div>
        ...
        >
          ...
          <Column
            ...
            header="รหัสทำงานด้าน"
            class="text-center"
            :sortable="true"
          ></Column>
          <Column
            field="PositionTypeName"
            header="ชื่อทำงานด้าน"
            class="text-center"
            :sortable="true"
          ></Column>
        ...
        <div class="col-12 lg:col-12">
          <div class="formgrid grid">
            <div class="field col-12 sm:col-12">
              <label class="block text-sm font-bold mb-2">รหัสทำงานด้าน</label>
              <InputText
                type="text"
                class="w-full"
