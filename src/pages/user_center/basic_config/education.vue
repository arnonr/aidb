<template>
  <div class="grid">
    <!-- start main page -->
    <div class="col-12">
      <PageTitle title="ข้อมูลระดับการศึกษา" :pages="breadcrumb" />
      ...
      <div class="mt-5 card">
        <div class="grid flex align-items-center mb-5">
          <div class="col-12 md:col-6">
            <h1 class="text-2xl mb-0 text-600">ข้อมูลระดับการศึกษา</h1>
          </div>
        ...
        >
          ...
          <Column
            field="EducationCode"
            header="รหัสระดับการศึกษา"
            class="text-center"
            :sortable="true"
          ></Column>
          <Column
            field="EducationName"
            header="ชื่อระดับการศึกษา"
            class="text-center"
            :sortable="true"
          ></Column>
          <Column
            field="EducationNameEN"
            header="ชื่อระดับการศึกษาอังกฤษ"
            class="text-center"
            :sortable="true"
          >
          </Column>
          ...
          <Column header="จัดการ" class="text-center">
            <template #body="slotProps">
              <Button
                ...
                @click="open_edit(slotProps.data.EducationID)"
              />
              <Button
                label="ลบ"
                icon="pi pi-trash"
    ...
    <!-- Add Dialog -->
    <Dialog
      header="เพิ่มข้อมูลระดับการศึกษา"
          ...
          <div class="formgrid grid">
            <div class="field col-12 sm:col-12">
              <label class="block text-600 text-sm font-bold mb-2">
                รหัสระดับการศึกษา</label
              >
              <InputText
                type="text"
                class="w-full"
                :class="{ 'p-invalid': !form.EducationCode && valid }"
                v-model="form.EducationCode"
              />
            </div>
            <div class="field col-12 sm:col-12">
              <label class="block text-600 text-sm font-bold mb-2">
              ...
              <InputText
                type="text"
                class="w-full"
                :class="{ 'p-invalid': !form.EducationName && valid }"
                v-model="form.EducationName"
              />
            </div>
            <div class="field col-12 sm:col-12">
              <label class="block text-600 text-sm font-bold mb-2">
                ชื่อระดับการศึกษาภาษาอังกฤษ
              </label>
              <InputText
                type="text"
                class="w-full"
                :class="{ 'p-invalid': !form.EducationNameEN && valid }"
                v-model="form.EducationNameEN"
              />
            </div>
            <div class="field col-12 sm:col-12 lg:col-12">
              ...
              >
                <RadioButton
                  :id="isActive.key"
                  EducationName="category"
                  :value="isActive"
                  v-model="form.isActive"
                />
                <label :for="isActive.key">{{ isActive.EducationName }}</label>
              </div>
            </div>
          </div>
        </div>
    ...
    <!-- EDIT Dialog -->
    <Dialog
      header="แก้ไขข้อมูลระดับการศึกษา"
    ...
    >
      <div class="confirmation-content text-center">
        ...
        <br />
        <span class="text-xl"
          >คุณต้องการลบข้อมูลระดับการศึกษาลำดับที่
...
export default {
  ...
  data() {
    return {
      ...
      status: [
        { EducationName: "เปิดการใช้งาน", key: "A", value: 1 },
        { EducationName: "ปิดการใช้งาน", key: "B", value: 0 },
      ],
  ...
  methods: {
    ...
    validation() {
      if (
        ...
        !this.form.EducationName ||
        !this.form.EducationNameEN
      ) {
        this.valid = true;
        this.$toast.add({
          severity: "error",
    ...
    open_edit(id) {
      id = this.data.find((x) => x.EducationID == id);
      // console.log(id);
      if (id.isActive == 0) {
      ...
      this.form = {
        id: id.EducationID,
        EducationCode: id.EducationCode,
        show_id: id.show_id,
        EducationName: id.EducationName,
        EducationNameEN: id.EducationNameEN,
