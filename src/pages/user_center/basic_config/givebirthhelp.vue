<template>
  <div class="grid">
    <!-- start main page -->
    <div class="col-12">
      <PageTitle title="วิธีการช่วยคลอด" :pages="breadcrumb" />
      ...
      <div class="mt-5 card">
        <div class="grid flex align-items-center mb-5">
          <div class="col-12 md:col-6">
            <h1 class="text-2xl mb-0 text-600">วิธีการช่วยคลอด</h1>
          </div>
        ...
        >
          ...
          ></Column>
          <Column
            field="GiveBirthHelpCode"
            header="รหัสวิธีการช่วยคลอด"
            class="text-center"
            :sortable="true"
          >
          </Column>
          <Column
            field="GiveBirthHelpName"
            header="ชื่อวิธีการช่วยคลอด"
            class="text-center"
            :sortable="true"
          >
          </Column>
          ...
          <Column header="จัดการ" class="text-center">
            <template #body="slotProps">
              <Button
                ...
                @click="open_edit(slotProps.data.GiveBirthHelpID)"
              />
              <Button
                label="ลบ"
                icon="pi pi-trash"
                ...
                @click="
                  open_delete(
                    slotProps.data.GiveBirthHelpID,
          ...
          <div class="formgrid grid">
            ...
            <div class="field col-12 sm:col-12">
              ...
              <InputText
                type="text"
                class="w-full"
                v-model="form.GiveBirthHelpName"
                :class="{ 'p-invalid': !form.GiveBirthHelpName && valid }"
              />
            </div>
...
export default {
  ...
  methods: {
    ...
    validation() {
      if (!this.form.GiveBirthHelpCode || !this.form.GiveBirthHelpName) {
        this.valid = true;
        this.$toast.add({
          severity: "error",
          summary: "ล้มเหลว",
    ...
    update() {
      ...
      this.form.isActive = this.form.isActive.value;
      axios
        .put(this.url + "/" + this.form.GiveBirthHelpID, this.form)
        .then(() => {
          this.close_edit();
          this.load();
          this.$toast.add({
    ...
    open_edit(id) {
      id = this.data.find((x) => x.GiveBirthHelpID == id);
      if (id.isActive == 0) {
      ...
      this.form = {
        GiveBirthHelpID: id.GiveBirthHelpID,
        GiveBirthHelpCode: id.GiveBirthHelpCode,
        GiveBirthHelpName: id.GiveBirthHelpName,
        GiveBirthHelpNameEN: id.GiveBirthHelpNameEN,
        show_id: id.show_id,
