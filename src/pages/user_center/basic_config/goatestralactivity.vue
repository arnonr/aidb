<template>
  <div class="grid">
    <!-- start main page -->
    <div class="col-12">
      <PageTitle title="โปรแกรมการเป็นสัดของแพะ" :pages="breadcrumb" />
      ...
      <div class="mt-5 card">
        <div class="grid flex align-items-center mb-5">
          <div class="col-12 md:col-6">
            <h1 class="text-2xl mb-0 text-600">โปรแกรมการเป็นสัดของแพะ</h1>
          </div>
        ...
        >
          ...
          ></Column>
          <Column
            field="GoatEstralActivityCode"
            header="รหัสโปรแกรมการเป็นสัดของแพะ"
            class="text-center"
            :sortable="true"
          ></Column>
          <Column
            field="GoatEstralActivityName"
            header="คำอธิบายโปรแกรมการเป็นสัด"
            class="text-center"
            :sortable="true"
          ></Column>
          <Column
          ...
          <Column header="จัดการ" class="text-center">
            <template #body="slotProps">
              <Button
                ...
                @click="open_edit(slotProps.data.GoatEstralActivityID)"
              />
              <Button
                label="ลบ"
                icon="pi pi-trash"
                ...
                @click="
                  open_delete(
                    slotProps.data.GoatEstralActivityID,
          ...
          <div class="formgrid grid">
            <div class="field col-12 sm:col-12">
              <label class="block text-sm font-bold mb-2"
                >รหัสโปรแกรมการเป็นสัดของแพะ</label
              >
              <InputText
                type="text"
                class="w-full"
                :class="{ 'p-invalid': !form.GoatEstralActivityCode && valid }"
                v-model="form.GoatEstralActivityCode"
              />
            </div>

            <div class="field col-12 sm:col-12">
              <label class="block text-sm font-bold mb-2">
                คำอธิบายโปรแกรมการเป็นสัด
              </label>
              <InputText
                type="text"
                class="w-full"
                v-model="form.GoatEstralActivityName"
                :class="{ 'p-invalid': !form.GoatEstralActivityName && valid }"
              />
            </div>
            <div class="field col-12 sm:col-12">
...
export default {
  ...
  data() {
    return {
      url: "/goat-estral-activity",
      breadcrumb: [
        { label: "ข้อมูลพื้นฐานระบบ", to: "/user_center/dashboard" },
        { label: "โปรแกรมการเป็นสัดของแพะ", to: "" },
      ],
      search: {
  ...
  methods: {
    ...
    validation() {
      if (
        !this.form.GoatEstralActivityCode ||
        !this.form.GoatEstralActivityName
      ) {
        this.valid = true;
        this.$toast.add({
          severity: "error",
    ...
    update() {
      ...
      this.form.isActive = this.form.isActive.value;
      axios
        .put(this.url + "/" + this.form.GoatEstralActivityID, this.form)
        .then(() => {
          this.close_edit();
          this.load();
          this.$toast.add({
    ...
    open_edit(id) {
      id = this.data.find((x) => x.GoatEstralActivityID == id);
      if (id.isActive == 0) {
      ...
      this.form = {
        GoatEstralActivityID: id.GoatEstralActivityID,
        GoatEstralActivityCode: id.GoatEstralActivityCode,
        GoatEstralActivityName: id.GoatEstralActivityName,
        Remark: id.Remark,
        show_id: id.show_id,
