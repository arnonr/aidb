<template>
  <div class="grid">
    <!-- start main page -->
    <div class="col-12">
      <PageTitle title="อาชีพ" :pages="breadcrumb" />
      ...
      <div class="mt-5 card">
        <div class="grid flex align-items-center mb-5">
          <div class="col-12 md:col-6">
            <h1 class="text-2xl mb-0 text-600">อาชีพ</h1>
          </div>
        ...
        >
          ...
          <Column
            ...
            header="ชื่ออาชีพ (ภาษาไทย)"
            class="text-center"
            :sortable="true"
          ></Column>
          <Column
            field="OccupationNameEN"
            header="ชื่ออาชีพ (ภาษาอังกฤษ)"
            class="text-center"
            :sortable="true"
          >
          </Column>
          ...
          <Column header="จัดการ" class="text-center">
            <template #body="slotProps">
              <Button
                ...
                @click="open_edit(slotProps.data.OccupationID)"
              />
              <Button
                label="ลบ"
                icon="pi pi-trash"
        ...
        <div class="col-12 lg:col-12">
          <div class="formgrid grid">
            <div class="field col-12 sm:col-12">
              <label class="block text-sm font-bold mb-2">รหัสอาชีพ</label>
              <InputText
                type="text"
                class="w-full"
                :class="{ 'p-invalid': !form.OccupationCode && valid }"
            ...
            <div class="field col-12 sm:col-12">
              ...
              <InputText
                ...
                :class="{ 'p-invalid': !form.OccupationName && valid }"
              />
            </div>
            ...
            <div class="field col-12 sm:col-12">
              ...
              <InputText
                type="text"
                class="w-full"
                v-model="form.OccupationNameEN"
                :class="{ 'p-invalid': !form.OccupationNameEN && valid }"
              />
            </div>
...
export default {
  ...
  methods: {
    ...
    validation() {
      if (!this.form.OccupationCode || !this.form.OccupationName) {
        this.valid = true;
        this.$toast.add({
          severity: "error",
          summary: "ล้มเหลว",
    ...
    update() {
      ...
      this.form.isActive = this.form.isActive.value;
      axios
        .put(this.url + "/" + this.form.OccupationID, this.form)
        .then(() => {
          this.close_edit();
          this.load();
          this.$toast.add({
    ...
    open_edit(id) {
      id = this.data.find((x) => x.OccupationID == id);
      if (id.isActive == 0) {
      ...
      this.form = {
        OccupationID: id.OccupationID,
        OccupationCode: id.OccupationCode,
        OccupationName: id.OccupationName,
        OccupationNameEN: id.OccupationNameEN,
        show_id: id.show_id,
