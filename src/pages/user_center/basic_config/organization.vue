  ...
  <div class="grid">
    ...
    <div class="col-12">
      ...
      <div class="mt-5 card">
        ...
        >
          ...
          <Column
            field="ProvinceName"
            header="ชื่อจังหวัด (ภาษาไทย)"
            class="text-center"
            :sortable="true"
          ></Column>
          <Column
            field="ProvinceNameEN"
            header="ชื่อจังหวัด (ภาษาอังกฤษ)"
            class="text-center"
            :sortable="true"
          >
          </Column>
          ...
          <Column header="จัดการ" class="text-center">
            <template #body="slotProps">
              ...
              <Button
                ...
                @click="open_delete(slotProps.data.id)"
              />
            </template>
          </Column>
        </DataTable>
          ...
          <div class="formgrid grid">
            <div class="field col-12 sm:col-12">
              ...
              <InputText
                type="text"
                class="w-full"
                :class="{ 'p-invalid': !form.ProvinceCode && valid }"
    ...
    >
      <div class="confirmation-content text-center">
        ...
        <br />
        <span class="text-xl"
          >คุณต้องการลบสถานะสัตว์ลำดับที่ {{ form.id }} ใช่หรือไม่</span
        >
      </div>
      <template #footer>
...
export default {
  ...
  methods: {
    ...
    load() {
      ...
      axios.get(this.getOrganization).then((response) => {
        this.organization_type = response.data.rows;
      });
    },
    add() {
      // validation
