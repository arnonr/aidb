<template>
  <div class="grid">
    <!-- start main page -->
    <div class="col-12">
      <PageTitle title="ประเภทบุคลากร" :pages="breadcrumb" />
      ...
      <div class="mt-5 card">
        <div class="grid flex align-items-center mb-5">
          <div class="col-12 md:col-6">
            <h1 class="text-2xl mb-0 text-600">ประเภทบุคลากร</h1>
          </div>
        ...
        >
          ...
          <Column
            ...
            header="รหัสประเภทบุคลากร"
            class="text-center"
            :sortable="true"
          ></Column>
          <Column
            field="PositionTypeName"
            header="ชื่อประเภทบุคลากร"
            class="text-center"
            :sortable="true"
          ></Column>
          ...
          <Column header="จัดการ" class="text-center">
            <template #body="slotProps">
              <Button
                ...
                @click="open_edit(slotProps.data.PositionTypeID)"
              />
              <Button
                label="ลบ"
                icon="pi pi-trash"
          ...
          <div class="formgrid grid">
            <div class="field col-12 sm:col-12">
              <label class="block text-sm font-bold mb-2"
                >รหัสประเภทบุคลากร</label
              >
              <InputText
                type="text"
                class="w-full"
                :class="{ 'p-invalid': !form.PositionTypeCode && valid }"
                v-model="form.PositionTypeCode"
              />
            </div>
            ...
            <div class="field col-12 sm:col-12">
              ...
              <InputText
                ...
                :class="{ 'p-invalid': !form.PositionTypeName && valid }"
              />
            </div>
...
export default {
  ...
  methods: {
    ...
    validation() {
      if (!this.form.PositionTypeCode || !this.form.PositionTypeName) {
        this.valid = true;
        this.$toast.add({
          severity: "error",
          summary: "ล้มเหลว",
    ...
    update() {
      ...
      this.form.isActive = this.form.isActive.value;
      axios
        .put(this.url + "/" + this.form.PositionTypeID, this.form)
        .then(() => {
          this.close_edit();
          this.load();
          this.$toast.add({
    ...
    open_edit(id) {
      id = this.data.find((x) => x.PositionTypeID == id);
      if (id.isActive == 0) {
      ...
      this.form = {
        PositionTypeID: id.PositionTypeID,
        PositionTypeCode: id.PositionTypeCode,
        PositionTypeName: id.PositionTypeName,
        PositionTypeNameEN: id.PositionTypeNameEN,
        show_id: id.show_id,
