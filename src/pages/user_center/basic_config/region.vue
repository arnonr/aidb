<template>
  <div class="grid">
    <!-- start main page -->
    <div class="col-12">
      <PageTitle title="ภูมิภาค" :pages="breadcrumb" />
      ...
      <div class="mt-5 card">
        <div class="grid flex align-items-center mb-5">
          <div class="col-12 md:col-6">
            <h1 class="text-2xl mb-0 text-600">ภูมิภาค</h1>
          </div>
        ...
        >
          ...
          <Column
            field="RegionName"
            header="ชื่อภูมิภาค (ภาษาไทย)"
            class="text-center"
            :sortable="true"
          ></Column>
          <Column
            field="RegionNameEN"
            header="ชื่อภูมิภาค (ภาษาอังกฤษ)"
            class="text-center"
            :sortable="true"
          ></Column>
          ...
          <Column header="จัดการ" class="text-center">
            <template #body="slotProps">
              <Button
                ...
                @click="open_edit(slotProps.data.RegionID)"
              />
              <Button
                label="ลบ"
                icon="pi pi-trash"
                ...
                @click="
                  open_delete(slotProps.data.RegionID, slotProps.data.show_id)
                "
              />
            </template>
          </Column>
        ...
        <div class="col-12 lg:col-12">
          <div class="formgrid grid">
            <div class="field col-12 sm:col-12">
              <label class="block text-sm font-bold mb-2">รหัสภูมิภาค</label>
              <InputText
                type="text"
                class="w-full"
                :class="{ 'p-invalid': !form.RegionCode && valid }"
            ...
            <div class="field col-12 sm:col-12">
              ...
              <InputText
                ...
                :class="{ 'p-invalid': !form.RegionName && valid }"
              />
            </div>

            <div class="field col-12 sm:col-12">
              <label class="block text-sm font-bold mb-2">
                ชื่อภูมิภาค (ภาษาอังกฤษ)
              </label>
              <InputText
                type="text"
                class="w-full"
                v-model="form.RegionNameEN"
                :class="{ 'p-invalid': !form.RegionNameEN && valid }"
              />
            </div>
...
export default {
  ...
  methods: {
    ...
    update() {
      ...
      this.form.isActive = this.form.isActive.value;
      axios
        .put(this.url + "/" + this.form.RegionID, this.form)
        .then(() => {
          this.close_edit();
          this.load();
          this.$toast.add({
    ...
    open_edit(id) {
      id = this.data.find((x) => x.RegionID == id);
      if (id.isActive == 0) {
