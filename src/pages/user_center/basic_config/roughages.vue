<template>
  <div class="grid">
    <!-- start main page -->
    <div class="col-12">
      <PageTitle title="อาหารหยาบ" :pages="breadcrumb" />
      ...
      <div class="mt-5 card">
        <div class="grid flex align-items-center mb-5">
          <div class="col-12 md:col-6">
            <h1 class="text-2xl mb-0 text-600">อาหารหยาบ</h1>
          </div>
  ...
  methods: {
    ...
    load() {
      axios.get(this.url).then((response) => {
        this.data = response.data.rows.filter((item) => item.FoodType == "2");
