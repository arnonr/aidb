                        ...
                        <Column header="จัดการ" class="text-center">
                            <template #body="slotProps">
                                <Button
                                    ...
                                    @click="
                                        toggle($event, slotProps.data.UserID)
                                    "
                                    class="p-button-text"
                                />
            ...
            <form class="grid mt-2">
                <div class="col-12 lg:col-12">
                    <div class="grid">
                        <div class="col-12 lg:col-12">
                            <label
                                class="block text-600 text-sm font-bold mb-1"
                            >
                                ชื่อบุคลากร</label
                            >
                            <Dropdown
                                ...
                                :class="{
                                    'p-invalid': !data[index].StaffID && valid,
                                }"
                            />
                        </div>
                        <div class="col-4">
                ...
                Coding Beauty Blog
                        ...
                        <div class="col-12 sm:col-12 lg:col-6">
                            ...
                            <InputText
                                ...
                                class="w-full"
                                :class="{
                                    'p-invalid': !data[index].Username && valid,
                                }"
                            />
                        </div>
                        <div class="col-2 sm:col-12 lg:col-6 field p-fluid">
                            ...
                            <Password
                                ...
                                toggleMask
                                :class="{
                                    'p-invalid': !data[index].Password && valid,
                                }"
                            />
                        </div>
                        <div class="col-2 sm:col-12 lg:col-6">
                            ...
                            <Dropdown
                                ...
                                :class="{
                                    'p-invalid': !data[index].GroupID && valid,
                                }"
                            >
                            </Dropdown>
                        </div>
                        ...
                        <div class="col-12 sm:col-12 lg:col-8 grid">
                            ...
                            <div class="field col-12 sm:col-6">
                                ...
                                <Dropdown
                                    ...
                                    v-model="
                                        data[index].Staff.StaffPositionTypeID
                                    "
                                    disabled
                            ...
                            <div class="field col-12 sm:col-12">
                                ...
                                <Dropdown
                                    ...
                                    optionValue="OrganizationID"
                                    v-model="
                                        data[index].Staff.StaffOrganizationID
                                    "
                                    disabled
                                    :virtualScrollerOptions="{ itemSize: 38 }"
...
export default {
    ...
    data() {
        return {
            ...
            urlOrganization:
                "/organization/selection?isActive=1&includeAll=false1",
    ...
    methods: {
        ...
        add() {
            ...
            // update data
                ...
                if (this.isCard == 0) {
                    ...
                    if (
                        ...
                        axios
                            ...
                            .then((response) => {
                                form_staff.StaffNumber =
                                    response.data.StaffNumber;
                            });
                    }

                    form_staff.isCard = this.data[this.index].Staff.isCard;
                    axios.put(
                        "/staff/" + this.data[this.index].StaffID,
                        form_staff
                    );
                }
                ...
                axios
                    .put(
                        this.url.user + "/" + this.data[this.index][this.id],
                        form
                    )
                    .then(() => {
                        this.close();
        ...
        remove() {
            axios
                .put(this.url.user + "/" + this.data[this.index][this.id], {
                    isActive: 0,
                })
                .then(() => {
                    this.close_delete();
