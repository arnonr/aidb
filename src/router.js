...
const routes = [
    ...
    },
    {
        ...
        children: [
            //  ทะเบียน===========================================================================
            {
                ...
                children: [
                    //  ทะเบียนสัตว์
                    {
                        ...
                        component: () =>
                            import("./pages/creature/creature-search.vue"),
                        beforeEnter: async (to, from, next) => {
                            let authorize = await menu_authorize(
                                3,
                                "IsPreview",
                                {
                                    from,
                    ...
                    },
                    {
                        ...
                        name: "addcreature",
                        component: () =>
                            import("./pages/creature/creature-add.vue"),
                    },
                    {
                        path: "/creature/edit/:id",
                        name: "editcreature",
                        component: () =>
                            import("./pages/creature/creature-edit.vue"),
                    },
                    {
                        path: "/creaturebaby/add",
                        name: "addcreaturebaby",
                        component: () =>
                            import("./pages/creaturebaby/creature-add.vue"),
                    },
                    {
                        path: "/creaturebaby/edit/:id",
                        name: "editcreaturebaby",
                        component: () =>
                            import("./pages/creaturebaby/creature-edit.vue"),
                    },
                    //  ทะเบียนฟาร์ม
                    {
                        path: "farm",
                    ...
                    //  ทะเบียนบุคลากร
                    {
                        ...
                        name: "personnel",
                        component: () =>
                            import("./pages/personnel/Personnel.vue"),
                        beforeEnter: async (to, from, next) => {
                            let authorize = await menu_authorize(
                                1,
                                "IsPreview",
                    ...
                    //  ทะเบียนเกษตรกร
                    {
                        ...
                        name: "agencyfarmer",
                        component: () =>
                            import("./pages/farmerdata/famerdata.vue"),
                        beforeEnter: async (to, from, next) => {
                            let authorize = await menu_authorize(
                                2,
                                "IsPreview",
                    ...
                    //  ทะเบียนตัวอ่อน
                    {
                        ...
                        component: () =>
                            import(
                                "./pages/registration-embryo/AllRegEmbryo.vue"
                            ),
                        beforeEnter: async (to, from, next) => {
                            let authorize = await menu_authorize(
                                5,
            ...
            //  กำหนดโปรแกรมสำหรับแม่ตัวให้/ตัวรับ
            {
                ...
                name: "mainsetting",
                component: () =>
                    import("./pages/mainsetting/SettingProgramAll.vue"),
                beforeEnter: async (to, from, next) => {
                    let authorize = await menu_authorize(6, "IsPreview", {
                        from,
                        next,
                    });
                    if (authorize) {
            ...
            //  เตรียมแม่ตัวให้ (Donor ET)
            {
                ...
                beforeEnter: async (to, from, next) => {
                    let authorize = await menu_authorize(7, "IsPreview", {
                        from,
                        next,
                    });
                    if (authorize) {
            ...
            //  บันทึกเก็บตัวอ่อน
            {
                ...
                beforeEnter: async (to, from, next) => {
                    let authorize = await menu_authorize(8, "IsPreview", {
                        from,
                        next,
                    });
                    if (authorize) {
            ...
            //  เตรียมแม่ตัวรับ (Recipient)
            {
                ...
                name: "mainrecipient",
                component: () =>
                    import("./pages/mainrecipient/RecipientAll.vue"),
                beforeEnter: async (to, from, next) => {
                    let authorize = await menu_authorize(9, "IsPreview", {
                        from,
                        next,
                    });
                    if (authorize) {
            ...
            //  ย้ายฝากตัวอ่อน
            {
                ...
                beforeEnter: async (to, from, next) => {
                    let authorize = await menu_authorize(10, "IsPreview", {
                        from,
                        next,
                    });
                    if (authorize) {
            ...
            },
            {
                ...
                component: () =>
                    import("./pages/maintransfer/TransferEdit.vue"),
                beforeEnter: async (to, from, next) => {
                    let authorize = await menu_authorize(10, "IsPreview", {
                        from,
                        next,
            ...
            },
            {
                ...
                name: "Recipient1",
                component: () =>
                    import("./pages/mainrecipient/AddRecipient.vue"),
                beforeEnter: async (to, from, next) => {
                    let authorize = await menu_authorize(9, "IsPreview", {
                        from,
                        next,
            ...
            },
            {
                ...
                name: "Recipient2",
                component: () =>
                    import("./pages/mainrecipient/AddRecipient2.vue"),
                beforeEnter: async (to, from, next) => {
                    let authorize = await menu_authorize(9, "IsPreview", {
                        from,
                        next,
            ...
            //  เจ้าหน้าที่ผสมเทียม=========================================================
            {
                ...
                children: [
                    //  ข้อมูลฟาร์ม
                    {
                        ...
                        name: "farm-info",
                        component: () =>
                            import("./pages/farm_info/farm_info.vue"),
                        beforeEnter: async (to, from, next) => {
                            let authorize = await menu_authorize(
                                11,
                                "IsPreview",
                    ...
                    //  ข้อมูลสัตว์
                    {
                        ...
                        name: "creature_info",
                        component: () =>
                            import("./pages/farm_info/animal_info.vue"),
                        beforeEnter: async (to, from, next) => {
                            let authorize = await menu_authorize(
                                12,
                                "IsPreview",
                    ...
                    //  ข้อมูลสัตว์
                    {
                        ...
                        component: () =>
                            import("./pages/creature_info/creature_info.vue"),
                        beforeEnter: async (to, from, next) => {
                            let authorize = await menu_authorize(
                                12,
                                "IsPreview",
                    ...
                    //  แจ้งเตือนรายวัน
                    {
                        ...
                        name: "daily-alert",
                        component: () =>
                            import("./pages/daily-alert/daily-alert.vue"),
                        beforeEnter: async (to, from, next) => {
                            let authorize = await menu_authorize(
                                13,
                                "IsPreview",
                    ...
                    //  การจัดเก็บข้อมูลการขุน/อาหาร
                    {
                        ...
                        children: [
...

                            {
                                ...
                                name: "addfood",
                                component: () =>
                                    import("./pages/food/FoodAdd.vue"),
                            },
                            {
                                path: "add1",
                                name: "add1",
                                component: () =>
                                    import("./pages/food/FoodGrowUp.vue"),
                            },
                            {
                                path: "progress/:id",
                                name: "progressfood",
                                component: () =>
                                    import("./pages/food/FoodProgress.vue"),
                            },
                            {
                                path: "edit/:id",
                                name: "editfood",
                                component: () =>
                                    import("./pages/food/FoodEdit.vue"),
                            },
                            {
                                path: "tmr",
                                name: "tmrfood",
                                component: () =>
                                    import("./pages/food/FoodTMR.vue"),
                            },
                        ],
                    },
                    //  ฉีดวัคซีน
                        ...
                        children: [
                            {
                                ...
                                name: "vaccuine",
                                component: () =>
                                    import("./pages/vaccine/Vaccine.vue"),
                            },
                            {
                                path: "add/:id/:farm",
                                name: "vaccuineadd",
                                component: () =>
                                    import("./pages/vaccine/VaccineAdd.vue"),
                            },
                            {
                                path: "edit/:id",
                                name: "vaccuineedit",
                                component: () =>
                                    import("./pages/vaccine/VaccineEdit.vue"),
                            },
                            {
                                path: "view/:id",
                                name: "vaccuineview",
                                component: () =>
                                    import("./pages/vaccine/VaccineView.vue"),
                            },
                            // {
                            //   path: "add",
                        ...
                        children: [
                            {
                                ...
                                component: () =>
                                    import(
                                        "./pages/distributions/Distributions.vue"
                                    ),
                            },
                            {
                                path: "add/:id/:farm",
                                ...
                                component: () =>
                                    import(
                                        "./pages/distributions/DistributionsAdd.vue"
                                    ),
                            },
                            {
                                path: "edit/:id",
                                ...
                                component: () =>
                                    import(
                                        "./pages/distributions/DistributionsEdit.vue"
                                    ),
                            },
                            {
                                path: "view/:id",
                                ...
                                component: () =>
                                    import(
                                        "./pages/distributions/DistributionsView.vue"
                                    ),
                            },
                            // {
                            //   path: "add",
                        ...
                        children: [
                            {
                                ...
                                name: "all-diagnose",
                                component: () =>
                                    import("./pages/diagnose/AllDiagnose.vue"),
                            },
                            {
                                path: "view/:id",
                                name: "view-diagnose",
                                component: () =>
                                    import("./pages/diagnose/ViewDiagnose.vue"),
                            },
                            {
                                path: "add/:id/:farm",
                                name: "add-diagnose",
                                component: () =>
                                    import("./pages/diagnose/AddDiagnose.vue"),
                            },
                            {
                                path: "edit/:id",
                                name: "edit-diagnose",
                                component: () =>
                                    import("./pages/diagnose/EditDiagnose.vue"),
                            },
                        ],
                    },
                    //  การรักษา
                        ...
                        children: [
                            {
                                ...
                                component: () =>
                                    import(
                                        "./pages/treatment/AllTreatment.vue"
                                    ),
                            },
                            {
                                path: "add/:id/:farm",
                                ...
                                component: () =>
                                    import(
                                        "./pages/treatment/TreatmentAdd.vue"
                                    ),
                            },
                            {
                                path: "edit/:id",
                                ...
                                component: () =>
                                    import(
                                        "./pages/treatment/TreatmentEdit.vue"
                                    ),
                            },
                        ],
                    },
                        ...
                        children: [
                            {
                                ...
                                name: "all-deworm",
                                component: () =>
                                    import("./pages/deworm/Deworm.vue"),
                            },
                            {
                                path: "view/:id",
                                name: "view-deworm",
                                component: () =>
                                    import("./pages/deworm/DewormView.vue"),
                            },
                            {
                                path: "add/:id/:farm",
                                name: "dewormadd",
                                component: () =>
                                    import("./pages/deworm/DewormAdd.vue"),
                            },
                            {
                                path: "edit/:id",
                                name: "dewormedit",
                                component: () =>
                                    import("./pages/deworm/DewormEdit.vue"),
                            },
                        ],
                    },
                ],
            ...
            },
            {
                ...
                component: () =>
                    import("./pages/project/project-detail-animal.vue"),
            },
            {
                path: "/project/detail-diary",
                name: "project-detail-diary",
                component: () =>
                    import("./pages/project/project-detail-diary.vue"),
            },
            // {
            //     path: "/project/thaiblack",
            //     name: "project-thaiblack",
            //     component: () =>
            //         import("./pages/project/project-thaiblack.vue"),
            // },
            //   {
            //     path: "/project/thaiblack",
            //     name: "thaiblack",
            ...
            // },
            {
                ...
                component: () =>
                    import("./pages/project/project-artificial-add.vue"),
            },
            {
                path: "/project/creature/add",
                name: "project-creature-add",
                component: () =>
                    import("./pages/project/project-creature-add.vue"),
            },
            {
                ...
                children: [
                    {
                        ...
                        name: "all-thaiblack",
                        component: () =>
                            import("./pages/thaiblack/AllThaiblack.vue"),
                    },
                    {
                        path: "view/:id",
                        name: "view-thaiblack",
                        component: () =>
                            import("./pages/thaiblack/ViewThaiblack.vue"),
                    },
                    {
                        path: "add/:id/:farm",
                        name: "add-thaiblack",
                        component: () =>
                            import("./pages/thaiblack/AddThaiblack.vue"),
                    },
                    {
                        path: "edit/:id",
                        name: "edit-thaiblack",
                        component: () =>
                            import("./pages/thaiblack/EditThaiblack.vue"),
                    },
                ],
            },
            {
                ...
                children: [
                    {
                        ...
                        name: "all-redgoat",
                        component: () =>
                            import("./pages/redgoat/AllRedgoat.vue"),
                    },
                    {
                        path: "view/:id",
                        name: "view-redgoat",
                        component: () =>
                            import("./pages/redgoat/ViewRedgoat.vue"),
                    },
                    {
                        path: "add/:id/:farm",
                        name: "add-redgoat",
                        component: () =>
                            import("./pages/redgoat/AddRedgoat.vue"),
                    },
                    {
                        path: "edit/:id",
                        name: "edit-redgoat",
                        component: () =>
                            import("./pages/redgoat/EditRedgoat.vue"),
                    },
                ],
            },
            ...
            // รายงาน
            {
                ...
                children: [
                    ...
                    },
                    {
                        ...
                        name: "animalbreed",
                        component: () =>
                            import("./pages/report/AnimalBreed.vue"),
                    },
                    {
                        path: "FarmReport",
                        name: "FarmReport",
                        component: () =>
                            import("./pages/report/FarmReport.vue"),
                    },
                    {
                        path: "Total_Animal",
                        name: "Total_Animal",
                        component: () =>
                            import("./pages/report/Total_Animal.vue"),
                    },
                    {
                        path: "farm",
                        name: "farm",
                    ...
                    },
                    {
                        ...
                        component: () =>
                            import("./pages/report/HistoryRegistration.vue"),
                    },
                    {
                        path: "pt6",
                        name: "pt6",
                    ...
                    },
                    {
                        ...
                        name: "pregnancy1",
                        component: () =>
                            import("./pages/report/Pregnancy2.vue"),
                    },
                    {
                        path: "pregnancy2",
                        name: "pregnancy2",
                        component: () =>
                            import("./pages/report/Pregnancy1.vue"),
                    },
                    {
                        path: "pregnancy3",
                        name: "pregnancy3",
                        component: () =>
                            import("./pages/report/Pregnancy3.vue"),
                    },
                    {
                        path: "pregnancy4",
                        name: "pregnancy4",
                        component: () =>
                            import("./pages/report/Pregnancy4.vue"),
                    },
                    {
                        path: "birth",
                        name: "birth",
                    ...
                    },
                    {
                        ...
                        component: () =>
                            import("./pages/report/CheckBirth.vue"),
                    },
                    {
                        path: "young",
                        name: "reportyoung",
                    ...
                    },
                    {
                        ...
                        component: () =>
                            import("./pages/report/ReproduceCheckup.vue"),
                    },
                    {
                        path: "CheckupDue",
                        name: "checkupdue",
                        component: () =>
                            import("./pages/report/CheckupDue.vue"),
                    },
                    {
                        path: "TotalPreg",
            ...
            //  ข้อมูลภาพรวม (monitor)
            {
                ...
                component: () =>
                    import("./pages/dashboard/dashboard-setting.vue"),
                beforeEnter: async (to, from, next) => {
                ...
                children: [
                    {
                        ...
                        component: () =>
                            import(
                                "./pages/user_center/basic_config/production_status.vue"
                            ),
                    },
                    {
                        path: "cow_status",
                        ...
                        component: () =>
                            import(
                                "./pages/user_center/basic_config/cow_status.vue"
                            ),
                    },
                    {
                        path: "production_status",
                    ...
                    },
                    {
                        ...
                        component: () =>
                            import(
                                "./pages/user_center/basic_config/cow_source.vue"
                            ),
                    },
                    {
                        path: "culling_status",
                        ...
                        component: () =>
                            import(
                                "./pages/user_center/basic_config/culling_status.vue"
                            ),
                    },
                    {
                        path: "culling_cause",
                        ...
                        component: () =>
                            import(
                                "./pages/user_center/basic_config/culling_cause.vue"
                            ),
                    },
                    {
                        path: "animal_type",
                        ...
                        component: () =>
                            import(
                                "./pages/user_center/basic_config/animal_type.vue"
                            ),
                    },
                    {
                        path: "breed_type",
                        ...
                        component: () =>
                            import(
                                "./pages/user_center/basic_config/breed_type.vue"
                            ),
                    },
                    {
                        path: "farm_type",
                        ...
                        component: () =>
                            import(
                                "./pages/user_center/basic_config/farm_type.vue"
                            ),
                    },
                    {
                        path: "zone",
                    ...
                    },
                    {
                        ...
                        component: () =>
                            import(
                                "./pages/user_center/basic_config/ai_zone.vue"
                            ),
                    },
                    {
                        path: "education",
                        ...
                        component: () =>
                            import(
                                "./pages/user_center/basic_config/education.vue"
                            ),
                    },
                    {
                        ...
                        component: () =>
                            import(
                                "./pages/user_center/basic_config/organization_type.vue"
                            ),
                    },
                    {
                        path: "position",
                        ...
                        component: () =>
                            import(
                                "./pages/user_center/basic_config/position.vue"
                            ),
                    },
                    {
                        path: "duty",
                    ...
                    },
                    {
                        ...
                        component: () =>
                            import(
                                "./pages/user_center/basic_config/academy_major.vue"
                            ),
                    },
                    {
                        path: "embryo_stages",
                        ...
                        component: () =>
                            import(
                                "./pages/user_center/basic_config/embryo_stages.vue"
                            ),
                    },
                    // {
                    //   path: "hormone",
                    ...
                    // },
                    {
                        ...
                        component: () =>
                            import(
                                "./pages/user_center/basic_config/give_birth_type.vue"
                            ),
                    },
                    {
                        path: "country",
                        ...
                        component: () =>
                            import(
                                "./pages/user_center/basic_config/country.vue"
                            ),
                    },
                    {
                        path: "region",
                        ...
                        component: () =>
                            import(
                                "./pages/user_center/basic_config/region.vue"
                            ),
                    },
                    {
                        path: "province",
                        ...
                        component: () =>
                            import(
                                "./pages/user_center/basic_config/province.vue"
                            ),
                    },
                    {
                        path: "amphur",
                        ...
                        component: () =>
                            import(
                                "./pages/user_center/basic_config/amphur.vue"
                            ),
                    },
                    {
                        path: "tumbol",
                        ...
                        component: () =>
                            import(
                                "./pages/user_center/basic_config/tumbol.vue"
                            ),
                    },
                    {
                        path: "gender",
                        ...
                        component: () =>
                            import(
                                "./pages/user_center/basic_config/gender.vue"
                            ),
                    },
                    {
                        path: "title",
                        ...
                        component: () =>
                            import(
                                "./pages/user_center/basic_config/title.vue"
                            ),
                    },
                    {
                        path: "education",
                    ...
                    },
                    {
                        ...
                        component: () =>
                            import(
                                "./pages/user_center/basic_config/occupation.vue"
                            ),
                    },

                    {
                        ...
                        component: () =>
                            import(
                                "./pages/user_center/basic_config/organization.vue"
                            ),
                    },
                    {
                        path: "animalsex",
                        ...
                        component: () =>
                            import(
                                "./pages/user_center/basic_config/animalsex.vue"
                            ),
                    },
                    {
                        path: "animalgenre",
                        ...
                        component: () =>
                            import(
                                "./pages/user_center/basic_config/animalgenre.vue"
                            ),
                    },
                    {
                        ...
                        component: () =>
                            import(
                                "./pages/user_center/basic_config/animalgrouptype.vue"
                            ),
                    },

                    {
                        ...
                        component: () =>
                            import(
                                "./pages/user_center/basic_config/farmstatus.vue"
                            ),
                    },
                    {
                        path: "marriedstatus",
                        ...
                        component: () =>
                            import(
                                "./pages/user_center/basic_config/marriedstatus.vue"
                            ),
                    },
                    {
                        path: "positiontype",
                        ...
                        component: () =>
                            import(
                                "./pages/user_center/basic_config/positiontype.vue"
                            ),
                    },
                    {
                        path: "bcs",
                        name: "bcs",
                        component: () =>
                            import("./pages/user_center/basic_config/bcs.vue"),
                    },
                    {
                        path: "gundepth",
                        name: "gundepth",
                        component: () =>
                            import(
                                "./pages/user_center/basic_config/gundepth.vue"
                            ),
                    },
                    {
                    ...
                    },
                    {
                        ...
                        component: () =>
                            import(
                                "./pages/user_center/basic_config/abortresult.vue"
                            ),
                    },
                    {
                        path: "givebirthhelp",
                        ...
                        component: () =>
                            import(
                                "./pages/user_center/basic_config/givebirthhelp.vue"
                            ),
                    },
                    {
                        path: "transfermethod",
                        ...
                        component: () =>
                            import(
                                "./pages/user_center/basic_config/transfermethod.vue"
                            ),
                    },
                    {
                        ...
                        component: () =>
                            import(
                                "./pages/user_center/basic_config/goatestralactivity.vue"
                            ),
                    },
                    {
                        path: "presetactivity",
                        ...
                        component: () =>
                            import(
                                "./pages/user_center/basic_config/presetactivity.vue"
                            ),
                    },
                    {
                        path: "distributions",
                        ...
                        component: () =>
                            import(
                                "./pages/user_center/basic_config/distributions.vue"
                            ),
                    },
                    {
                        path: "roughages",
                        ...
                        component: () =>
                            import(
                                "./pages/user_center/basic_config/roughages.vue"
                            ),
                    },
                    {
                        path: "concentrate",
                        ...
                        component: () =>
                            import(
                                "./pages/user_center/basic_config/concentrate.vue"
                            ),
                    },

                    {
                        ...
                        component: () =>
                            import(
                                "./pages/user_center/basic_config/disease.vue"
                            ),
                    },

                    {
                        ...
                        component: () =>
                            import(
                                "./pages/user_center/basic_config/diseasemethod.vue"
                            ),
                    },
                    {
                        path: "diseaseresult",
                        ...
                        component: () =>
                            import(
                                "./pages/user_center/basic_config/diseaseresult.vue"
                            ),
                    },
                    {
                        ...
                        component: () =>
                            import(
                                "./pages/user_center/basic_config/vaccineobjective.vue"
                            ),
                    },
                    {
                        path: "vaccine",
                        ...
                        component: () =>
                            import(
                                "./pages/user_center/basic_config/vaccine.vue"
                            ),
                    },
                    {
                        path: "dewormmedicine",
                        ...
                        component: () =>
                            import(
                                "./pages/user_center/basic_config/dewormmedicine.vue"
                            ),
                    },
                    {
                        path: "heattype",
                        ...
                        component: () =>
                            import(
                                "./pages/user_center/basic_config/heattype.vue"
                            ),
                    },
                    {
                        path: "heatcircle",
                        ...
                        component: () =>
                            import(
                                "./pages/user_center/basic_config/heatcircle.vue"
                            ),
                    },
                    {
                        path: "ovarysymptom",
                        ...
                        component: () =>
                            import(
                                "./pages/user_center/basic_config/ovarysymptom.vue"
                            ),
                    },
                    {
                        path: "vaginasymptom",
                        ...
                        component: () =>
                            import(
                                "./pages/user_center/basic_config/vaginasymptom.vue"
                            ),
                    },
                    {
                        path: "othersymptom",
                        ...
                        component: () =>
                            import(
                                "./pages/user_center/basic_config/othersymptom.vue"
                            ),
                    },
                    {
                        path: "causeanimal",
                        ...
                        component: () =>
                            import(
                                "./pages/user_center/basic_config/causeanimal.vue"
                            ),
                    },
                    {
                        ...
                        component: () =>
                            import(
                                "./pages/user_center/basic_config/causeenvironment.vue"
                            ),
                    },
                    {
                        path: "causefeeder",
                        ...
                        component: () =>
                            import(
                                "./pages/user_center/basic_config/causefeeder.vue"
                            ),
                    },
                    {
                        path: "causehealth",
                        ...
                        component: () =>
                            import(
                                "./pages/user_center/basic_config/causehealth.vue"
                            ),
                    },
                    {
                        path: "curehormone",
                        ...
                        component: () =>
                            import(
                                "./pages/user_center/basic_config/curehormone.vue"
                            ),
                    },
                    {
                        path: "cureantibiotic",
                        ...
                        component: () =>
                            import(
                                "./pages/user_center/basic_config/cureantibiotic.vue"
                            ),
                    },
                    {
                        path: "curevitamin",
                        ...
                        component: () =>
                            import(
                                "./pages/user_center/basic_config/curevitamin.vue"
                            ),
                    },
                    {
                ...
                children: [
                    {
                        ...
                        name: "farminfo",
                        component: () =>
                            import("./components/form/farm/FormInfo.vue"),
                    },
                    {
                        path: "/farm/farmer-info",
                        name: "farmerinfo",
                        component: () =>
                            import("./components/form/farm/FormFarmer.vue"),
                    },
                ],
            },
            {
                ...
                children: [
                    {
                        ...
                        name: "edit-farminfo",
                        component: () =>
                            import("./components/form/farm/EditFormInfo.vue"),
                    },
                    {
            ...
            },
            {
                ...
                children: [
                    ...
                    },
                    {
                        ...
                        name: "move-formfarm",
                        component: () =>
                            import("./components/form/farm/move/FormFarm.vue"),
                    },
                ],
            },
            ...
            //1.2 ติดตามงานโครงการ
            {
                ...
                name: "followproject",
                component: () =>
                    import("./pages/followproject/FollowProjectAll.vue"),
            },
            {
                path: "/report/history",
                name: "history",
...

            {
                ...
                name: "distribution",
                component: () =>
                    import("./pages/distribution/Distribution.vue"),
            },
            {
                path: "/activity/distribution/add/:id/:farm",
                name: "distributionadd",
                component: () =>
                    import("./pages/distributions/DistributionsAdd.vue"),
            },
            // {
            ...
            },
            {
                ...
                name: "artificial-hs",
                component: () =>
                    import("./pages/artificial-hs/AllArtificial-hs.vue"),
            },
            ...
            // 1.2.13
            {
                ...
                component: () =>
                    import("./pages/feed-profile/feed-profile-all.vue"),
            },
            // {
            //   path: "",
            ...
            // 1.2.10-11
            {
                ...
                name: "artificial-all",
                component: () =>
                    import("./pages/artificial/artificial-all.vue"),
            },
            // {
            //   path: "",
            //   name: "addartificial",
        ...
        children: [
            {
                ...
                name: "register-id",
                component: () =>
                    import("./components/form/register/register1.vue"),
            },
            {
                path: "/register/personal",
                name: "register-personal",
                component: () =>
                    import("./components/form/register/register2.vue"),
            },
            {
                path: "/register/info",
                name: "register-info",
                component: () =>
                    import("./components/form/register/register3.vue"),
            },
        ],
    },
    {
    ...
    },
    {
        ...
        name: "new-password",
        component: () =>
            import("./components/form/reset-password/resetpwd2.vue"),
    },
    {
        path: "/error",
        name: "error",
