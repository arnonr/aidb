        ...
        axios
          ...
          .then((response) => {
            if (response.data.StaffNumber == form) {
              data = response.data;
              axios
                .get("/user/user-by-staff-id/" + response.data.StaffID)
                .then((response) => {
                  if (response.data) {
              ...
              axios.get("/staff/staff-by-number/" + form).then((response) => {
                if (response.data.StaffNumber == form) {
                  data = response.data;
                  axios
                    .get("/user/user-by-staff-id/" + response.data.StaffID)
    ...
    register({ commit }, form) {
      return new Promise((resolve, reject) => {
        ...
        axios.post("/user/register", form).then(() => {
          ...
          axios
            .put(`/staff/${this.state.staff.StaffID}/mobile-phone`, mobile)
            .then(() => {
              resolve();
            })
            .catch((errors) => {
